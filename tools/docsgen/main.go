...
func main() {
	...
	out := flag.String(
		"out",
		"docs-2/reference/generated/agent-contracts.yaml",
...
func run(repoRoot, outPath string) error {
	...
	body, err := yaml.Marshal(map[string]any{"schemas": schemas})
	if err != nil {
	...
	header := []byte("# Code generated by tools/docsgen. DO NOT EDIT.\n")
	if err := os.WriteFile(destination, append(header, body...), 0o644); err != nil {
