 ...
 */
export function logsEmptyTitle(durableUnavailable, streamState) {
 ...
 */
export function logsEmptyDetail(durableUnavailable, streamState) {
  if (streamState === "unavailable") {
    return "The daemon is not serving /api/logs/stream. Reload once it is reachable.";
  }
