...
export const api = {
  ...
  taskAttempts: (id) => request(`/api/tasks/${id}/attempts`),
  taskChanges: (id, params) => request(`/api/tasks/${id}/changes` + qs(params)),
  taskDebug: (id, params) => request(`/api/tasks/${id}/debug` + qs(params)),
