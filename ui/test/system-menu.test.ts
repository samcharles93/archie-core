...
const navModel = await readFile(new URL("../src/lib/nav.ts", import.meta.url), "utf8");
const navGroup = await readFile(new URL("../src/components/topbar/NavGroup.vue", import.meta.url), "utf8");
