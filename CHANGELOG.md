...
The release stream. One version covers whatever changed; a
release's per-component sections are labelled beneath its heading.
...
### archied — The Messaging Service is severed from the store and workflow runtime
...
### archied — Channel lifecycle reaches the dashboard
...
### archied — Action playbooks: a second playbook shape, with typed results
...
### archied — Host packaging: `archie-messaging` now ships and updates
...
### archied — EDA: playbook action ids, and a dispatch idempotency ledger
...
### archied — Messaging Service extraction completed
...
### archied — Dashboard and containers
...
### archied — Memory engine unification
...
### archied — Readiness and shutdown
...
### archied — Daemon, gateway and workflow
