...
func (x *CapturedEvent) GetEventType() string {
	if x != nil {
		return x.EventType
	}
	return ""
...
type EventTypeHeaderCondition struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *EventTypeHeaderCondition) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *EventTypeHeaderCondition) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
type EventTypePayloadCondition struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *EventTypePayloadCondition) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *EventTypePayloadCondition) GetOp() string {
	if x != nil {
		return x.Op
	}
	return ""
...
func (x *EventTypePayloadCondition) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
type EventType struct {
	...
	HeaderConditions  []*EventTypeHeaderCondition  `protobuf:"bytes,4,rep,name=header_conditions,json=headerConditions,proto3" json:"header_conditions,omitempty"`
	PayloadConditions []*EventTypePayloadCondition `protobuf:"bytes,5,rep,name=payload_conditions,json=payloadConditions,proto3" json:"payload_conditions,omitempty"`
	Schema            map[string]string            `protobuf:"bytes,6,rep,name=schema,proto3" json:"schema,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *EventType) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
func (x *EventType) GetHeaderConditions() []*EventTypeHeaderCondition {
	if x != nil {
...
func (x *EventType) GetPayloadConditions() []*EventTypePayloadCondition {
	if x != nil {
		return x.PayloadConditions
	}
	return nil
}

func (x *EventType) GetSchema() map[string]string {
	if x != nil {
		return x.Schema
	}
	return nil
...
type Mapping struct {
	...
	EventTypeId string                 `protobuf:"bytes,7,opt,name=event_type_id,json=eventTypeId,proto3" json:"event_type_id,omitempty"`
	...
	LastMatchedAt *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=last_matched_at,json=lastMatchedAt,proto3" json:"last_matched_at,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Mapping) GetEventTypeId() string {
	if x != nil {
...
func (x *Mapping) GetMatchCount() int64 {
	if x != nil {
		return x.MatchCount
	}
	return 0
...
func (x *Mapping) GetLastMatchedAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *RecordMappingMatchRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RecordMappingMatchRequest) GetCaptureId() string {
	if x != nil {
		return x.CaptureId
	}
	return ""
...
type RecordMappingMatchResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RecordMappingMatchResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *InsertEventTypeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type InsertEventTypeResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *InsertEventTypeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_state_v1_state_proto_rawDesc = "" +
	...
	"\fprincipal_id\x18\x0e \x01(\tR\vprincipalId\"\xab\x02\n" +
	...
	"\rauthenticated\x18\b \x01(\bR\rauthenticated\x12\x1d\n" +
	"\n" +
	"event_type\x18\t \x01(\tR\teventType\"D\n" +
	"\x18EventTypeHeaderCondition\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"U\n" +
	"\x19EventTypePayloadCondition\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x0e\n" +
	"\x02op\x18\x02 \x01(\tR\x02op\x12\x14\n" +
	"\x05value\x18\x03 \x01(\tR\x05value\"\xd6\x03\n" +
	"\tEventType\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06source\x18\x02 \x01(\tR\x06source\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12O\n" +
	"\x11header_conditions\x18\x04 \x03(\v2\".state.v1.EventTypeHeaderConditionR\x10headerConditions\x12R\n" +
	"\x12payload_conditions\x18\x05 \x03(\v2#.state.v1.EventTypePayloadConditionR\x11payloadConditions\x127\n" +
	"\x06schema\x18\x06 \x03(\v2\x1f.state.v1.EventType.SchemaEntryR\x06schema\x129\n" +
	"\n" +
	...
	"\brequired\x18\x04 \x01(\bR\brequired\"\xfd\x02\n" +
	"\aMapping\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	...
	"\revent_type_id\x18\a \x01(\tR\veventTypeId\x12\x1f\n" +
	...
	"\x06source\x18\x01 \x01(\tR\x06source\"\x9e\x03\n" +
	"\aBinding\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	...
	"\x06filter\x18\r \x01(\tR\x06filter\"\xe6\x01\n" +
	...
	"\x15DeleteMappingResponse\"Y\n" +
	"\x19RecordMappingMatchRequest\x12\x1d\n" +
	"\n" +
	"mapping_id\x18\x01 \x01(\tR\tmappingId\x12\x1d\n" +
	"\n" +
	"capture_id\x18\x02 \x01(\tR\tcaptureId\"\x1c\n" +
	"\x1aRecordMappingMatchResponse\"L\n" +
	"\x16InsertEventTypeRequest\x122\n" +
	"\n" +
	"event_type\x18\x01 \x01(\v2\x13.state.v1.EventTypeR\teventType\")\n" +
	"\x17InsertEventTypeResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"L\n" +
	"\x16UpdateEventTypeRequest\x122\n" +
	"\n" +
	"event_type\x18\x01 \x01(\v2\x13.state.v1.EventTypeR\teventType\"\x19\n" +
	"\x17UpdateEventTypeResponse\"(\n" +
	"\x16DeleteEventTypeRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"\x19\n" +
	"\x17DeleteEventTypeResponse\"\x17\n" +
	"\x15ListEventTypesRequest\"N\n" +
	"\x16ListEventTypesResponse\x124\n" +
	"\vevent_types\x18\x01 \x03(\v2\x13.state.v1.EventTypeR\n" +
	"eventTypes\"C\n" +
	...
	"\x04task\x18\x01 \x01(\v2\x0e.state.v1.TaskR\x04task2\xfc/\n" +
	...
	"\rDeleteMapping\x12\x1e.state.v1.DeleteMappingRequest\x1a\x1f.state.v1.DeleteMappingResponse\x12_\n" +
	"\x12RecordMappingMatch\x12#.state.v1.RecordMappingMatchRequest\x1a$.state.v1.RecordMappingMatchResponse\x12V\n" +
	"\x0fInsertEventType\x12 .state.v1.InsertEventTypeRequest\x1a!.state.v1.InsertEventTypeResponse\x12V\n" +
	"\x0fUpdateEventType\x12 .state.v1.UpdateEventTypeRequest\x1a!.state.v1.UpdateEventTypeResponse\x12V\n" +
	"\x0fDeleteEventType\x12 .state.v1.DeleteEventTypeRequest\x1a!.state.v1.DeleteEventTypeResponse\x12S\n" +
	"\x0eListEventTypes\x12\x1f.state.v1.ListEventTypesRequest\x1a .state.v1.ListEventTypesResponse\x12P\n" +
...
var file_state_v1_state_proto_msgTypes = make([]protoimpl.MessageInfo, 165)
var file_state_v1_state_proto_goTypes = []any{
	...
	(*EventTypeHeaderCondition)(nil),           // 27: state.v1.EventTypeHeaderCondition
	(*EventTypePayloadCondition)(nil),          // 28: state.v1.EventTypePayloadCondition
	(*EventType)(nil),                          // 29: state.v1.EventType
	(*MappingField)(nil),                       // 30: state.v1.MappingField
	(*Mapping)(nil),                            // 31: state.v1.Mapping
	(*BindingMatcher)(nil),                     // 32: state.v1.BindingMatcher
	(*Binding)(nil),                            // 33: state.v1.Binding
	(*WorkflowStat)(nil),                       // 34: state.v1.WorkflowStat
	(*StageStat)(nil),                          // 35: state.v1.StageStat
	(*DayTokens)(nil),                          // 36: state.v1.DayTokens
	(*EnqueueIssueRequest)(nil),                // 37: state.v1.EnqueueIssueRequest
	(*EnqueueIssueResponse)(nil),               // 38: state.v1.EnqueueIssueResponse
	(*EnqueueChatTaskRequest)(nil),             // 39: state.v1.EnqueueChatTaskRequest
	(*EnqueueChatTaskResponse)(nil),            // 40: state.v1.EnqueueChatTaskResponse
	(*ClaimNextRequest)(nil),                   // 41: state.v1.ClaimNextRequest
	(*ClaimNextResponse)(nil),                  // 42: state.v1.ClaimNextResponse
	(*ClaimByIssueRequest)(nil),                // 43: state.v1.ClaimByIssueRequest
	(*ClaimByIssueResponse)(nil),               // 44: state.v1.ClaimByIssueResponse
	(*TransitionRequest)(nil),                  // 45: state.v1.TransitionRequest
	(*TransitionResponse)(nil),                 // 46: state.v1.TransitionResponse
	(*UpdateRequest)(nil),                      // 47: state.v1.UpdateRequest
	(*UpdateResponse)(nil),                     // 48: state.v1.UpdateResponse
	(*RequeueRequest)(nil),                     // 49: state.v1.RequeueRequest
	(*RequeueResponse)(nil),                    // 50: state.v1.RequeueResponse
	(*ParkTaskRequest)(nil),                    // 51: state.v1.ParkTaskRequest
	(*ParkTaskResponse)(nil),                   // 52: state.v1.ParkTaskResponse
	(*RecoverStaleRequest)(nil),                // 53: state.v1.RecoverStaleRequest
	(*RecoverStaleResponse)(nil),               // 54: state.v1.RecoverStaleResponse
	(*ArchiveTaskRequest)(nil),                 // 55: state.v1.ArchiveTaskRequest
	(*ArchiveTaskResponse)(nil),                // 56: state.v1.ArchiveTaskResponse
	(*RetryTaskRequest)(nil),                   // 57: state.v1.RetryTaskRequest
	(*RetryTaskResponse)(nil),                  // 58: state.v1.RetryTaskResponse
	(*BeginRemediationRequest)(nil),            // 59: state.v1.BeginRemediationRequest
	(*BeginRemediationResponse)(nil),           // 60: state.v1.BeginRemediationResponse
	(*UpdateReviewPayloadRequest)(nil),         // 61: state.v1.UpdateReviewPayloadRequest
	(*UpdateReviewPayloadResponse)(nil),        // 62: state.v1.UpdateReviewPayloadResponse
	(*SetReviewCursorsRequest)(nil),            // 63: state.v1.SetReviewCursorsRequest
	(*SetReviewCursorsResponse)(nil),           // 64: state.v1.SetReviewCursorsResponse
	(*TaskByIssueRequest)(nil),                 // 65: state.v1.TaskByIssueRequest
	(*TaskByIssueResponse)(nil),                // 66: state.v1.TaskByIssueResponse
	(*OpenTaskByPRRequest)(nil),                // 67: state.v1.OpenTaskByPRRequest
	(*OpenTaskByPRResponse)(nil),               // 68: state.v1.OpenTaskByPRResponse
	(*TaskByIDRequest)(nil),                    // 69: state.v1.TaskByIDRequest
	(*TaskByIDResponse)(nil),                   // 70: state.v1.TaskByIDResponse
	(*OpenPRsRequest)(nil),                     // 71: state.v1.OpenPRsRequest
	(*OpenPRsResponse)(nil),                    // 72: state.v1.OpenPRsResponse
	(*ClearTerminalTasksRequest)(nil),          // 73: state.v1.ClearTerminalTasksRequest
	(*ClearTerminalTasksResponse)(nil),         // 74: state.v1.ClearTerminalTasksResponse
	(*TasksRequest)(nil),                       // 75: state.v1.TasksRequest
	(*TasksResponse)(nil),                      // 76: state.v1.TasksResponse
	(*StatusCountsRequest)(nil),                // 77: state.v1.StatusCountsRequest
	(*StatusCountsResponse)(nil),               // 78: state.v1.StatusCountsResponse
	(*InsertEventRequest)(nil),                 // 79: state.v1.InsertEventRequest
	(*InsertEventResponse)(nil),                // 80: state.v1.InsertEventResponse
	(*EventsSinceRequest)(nil),                 // 81: state.v1.EventsSinceRequest
	(*EventsSinceResponse)(nil),                // 82: state.v1.EventsSinceResponse
	(*TaskEventsRequest)(nil),                  // 83: state.v1.TaskEventsRequest
	(*TaskEventsResponse)(nil),                 // 84: state.v1.TaskEventsResponse
	(*WorkflowStatsRequest)(nil),               // 85: state.v1.WorkflowStatsRequest
	(*WorkflowStatsResponse)(nil),              // 86: state.v1.WorkflowStatsResponse
	(*StageStatsRequest)(nil),                  // 87: state.v1.StageStatsRequest
	(*StageStatsResponse)(nil),                 // 88: state.v1.StageStatsResponse
	(*TokensByDayRequest)(nil),                 // 89: state.v1.TokensByDayRequest
	(*TokensByDayResponse)(nil),                // 90: state.v1.TokensByDayResponse
	(*ConfigSnapshot)(nil),                     // 91: state.v1.ConfigSnapshot
	(*PutConfigSnapshotRequest)(nil),           // 92: state.v1.PutConfigSnapshotRequest
	(*PutConfigSnapshotResponse)(nil),          // 93: state.v1.PutConfigSnapshotResponse
	(*GetConfigSnapshotRequest)(nil),           // 94: state.v1.GetConfigSnapshotRequest
	(*GetConfigSnapshotResponse)(nil),          // 95: state.v1.GetConfigSnapshotResponse
	(*ChannelStatus)(nil),                      // 96: state.v1.ChannelStatus
	(*PutChannelStatusRequest)(nil),            // 97: state.v1.PutChannelStatusRequest
	(*PutChannelStatusResponse)(nil),           // 98: state.v1.PutChannelStatusResponse
	(*ListChannelStatusRequest)(nil),           // 99: state.v1.ListChannelStatusRequest
	(*ListChannelStatusResponse)(nil),          // 100: state.v1.ListChannelStatusResponse
	(*ApplyStatus)(nil),                        // 101: state.v1.ApplyStatus
	(*PutApplyStatusRequest)(nil),              // 102: state.v1.PutApplyStatusRequest
	(*PutApplyStatusResponse)(nil),             // 103: state.v1.PutApplyStatusResponse
	(*ListApplyStatusRequest)(nil),             // 104: state.v1.ListApplyStatusRequest
	(*ListApplyStatusResponse)(nil),            // 105: state.v1.ListApplyStatusResponse
	(*TaskLogEntry)(nil),                       // 106: state.v1.TaskLogEntry
	(*ReadTaskLogRequest)(nil),                 // 107: state.v1.ReadTaskLogRequest
	(*ReadTaskLogResponse)(nil),                // 108: state.v1.ReadTaskLogResponse
	(*StreamTaskLogContentRequest)(nil),        // 109: state.v1.StreamTaskLogContentRequest
	(*StreamTaskLogContentResponse)(nil),       // 110: state.v1.StreamTaskLogContentResponse
	(*InsertCaptureRequest)(nil),               // 111: state.v1.InsertCaptureRequest
	(*InsertCaptureResponse)(nil),              // 112: state.v1.InsertCaptureResponse
	(*ListCapturesRequest)(nil),                // 113: state.v1.ListCapturesRequest
	(*ListCapturesResponse)(nil),               // 114: state.v1.ListCapturesResponse
	(*StreamCapturesRequest)(nil),              // 115: state.v1.StreamCapturesRequest
	(*StreamCapturesResponse)(nil),             // 116: state.v1.StreamCapturesResponse
	(*InsertMappingRequest)(nil),               // 117: state.v1.InsertMappingRequest
	(*InsertMappingResponse)(nil),              // 118: state.v1.InsertMappingResponse
	(*GetMappingRequest)(nil),                  // 119: state.v1.GetMappingRequest
	(*GetMappingResponse)(nil),                 // 120: state.v1.GetMappingResponse
	(*ListMappingsRequest)(nil),                // 121: state.v1.ListMappingsRequest
	(*ListMappingsResponse)(nil),               // 122: state.v1.ListMappingsResponse
	(*UpdateMappingRequest)(nil),               // 123: state.v1.UpdateMappingRequest
	(*UpdateMappingResponse)(nil),              // 124: state.v1.UpdateMappingResponse
	(*DeleteMappingRequest)(nil),               // 125: state.v1.DeleteMappingRequest
	(*DeleteMappingResponse)(nil),              // 126: state.v1.DeleteMappingResponse
	(*RecordMappingMatchRequest)(nil),          // 127: state.v1.RecordMappingMatchRequest
	(*RecordMappingMatchResponse)(nil),         // 128: state.v1.RecordMappingMatchResponse
	(*InsertEventTypeRequest)(nil),             // 129: state.v1.InsertEventTypeRequest
	(*InsertEventTypeResponse)(nil),            // 130: state.v1.InsertEventTypeResponse
	(*UpdateEventTypeRequest)(nil),             // 131: state.v1.UpdateEventTypeRequest
	(*UpdateEventTypeResponse)(nil),            // 132: state.v1.UpdateEventTypeResponse
	(*DeleteEventTypeRequest)(nil),             // 133: state.v1.DeleteEventTypeRequest
	(*DeleteEventTypeResponse)(nil),            // 134: state.v1.DeleteEventTypeResponse
	(*ListEventTypesRequest)(nil),              // 135: state.v1.ListEventTypesRequest
	(*ListEventTypesResponse)(nil),             // 136: state.v1.ListEventTypesResponse
	(*InsertBindingRequest)(nil),               // 137: state.v1.InsertBindingRequest
	(*InsertBindingResponse)(nil),              // 138: state.v1.InsertBindingResponse
	(*GetBindingRequest)(nil),                  // 139: state.v1.GetBindingRequest
	(*GetBindingResponse)(nil),                 // 140: state.v1.GetBindingResponse
	(*ListBindingsRequest)(nil),                // 141: state.v1.ListBindingsRequest
	(*ListBindingsResponse)(nil),               // 142: state.v1.ListBindingsResponse
	(*UpdateBindingRequest)(nil),               // 143: state.v1.UpdateBindingRequest
	(*UpdateBindingResponse)(nil),              // 144: state.v1.UpdateBindingResponse
	(*DeleteBindingRequest)(nil),               // 145: state.v1.DeleteBindingRequest
	(*DeleteBindingResponse)(nil),              // 146: state.v1.DeleteBindingResponse
	(*ApproveBindingRequest)(nil),              // 147: state.v1.ApproveBindingRequest
	(*ApproveBindingResponse)(nil),             // 148: state.v1.ApproveBindingResponse
	(*ArmedBindingsForSourceRequest)(nil),      // 149: state.v1.ArmedBindingsForSourceRequest
	(*ArmedBindingsForSourceResponse)(nil),     // 150: state.v1.ArmedBindingsForSourceResponse
	(*RecordDispatchRequest)(nil),              // 151: state.v1.RecordDispatchRequest
	(*RecordDispatchResponse)(nil),             // 152: state.v1.RecordDispatchResponse
	(*RecordPlaybookDispatchRequest)(nil),      // 153: state.v1.RecordPlaybookDispatchRequest
	(*RecordPlaybookDispatchResponse)(nil),     // 154: state.v1.RecordPlaybookDispatchResponse
	(*DeletePlaybookDispatchesRequest)(nil),    // 155: state.v1.DeletePlaybookDispatchesRequest
	(*DeletePlaybookDispatchesResponse)(nil),   // 156: state.v1.DeletePlaybookDispatchesResponse
	(*ListUndispatchedCapturesRequest)(nil),    // 157: state.v1.ListUndispatchedCapturesRequest
	(*ListUndispatchedCapturesResponse)(nil),   // 158: state.v1.ListUndispatchedCapturesResponse
	(*StreamUndispatchedCapturesRequest)(nil),  // 159: state.v1.StreamUndispatchedCapturesRequest
	(*StreamUndispatchedCapturesResponse)(nil), // 160: state.v1.StreamUndispatchedCapturesResponse
	(*EnqueueBindingTaskRequest)(nil),          // 161: state.v1.EnqueueBindingTaskRequest
	(*EnqueueBindingTaskResponse)(nil),         // 162: state.v1.EnqueueBindingTaskResponse
	nil,                                        // 163: state.v1.EventType.SchemaEntry
	nil,                                        // 164: state.v1.StatusCountsResponse.CountsEntry
	(*timestamppb.Timestamp)(nil),              // 165: google.protobuf.Timestamp
}
var file_state_v1_state_proto_depIdxs = []int32{
	165, // 0: state.v1.Identity.created_at:type_name -> google.protobuf.Timestamp
	165, // 1: state.v1.Identity.updated_at:type_name -> google.protobuf.Timestamp
	...
	165, // 17: state.v1.Task.created_at:type_name -> google.protobuf.Timestamp
	165, // 18: state.v1.Task.updated_at:type_name -> google.protobuf.Timestamp
	165, // 19: state.v1.Event.at:type_name -> google.protobuf.Timestamp
	165, // 20: state.v1.CapturedEvent.received_at:type_name -> google.protobuf.Timestamp
	...
	163, // 23: state.v1.EventType.schema:type_name -> state.v1.EventType.SchemaEntry
	165, // 24: state.v1.EventType.created_at:type_name -> google.protobuf.Timestamp
	165, // 25: state.v1.EventType.updated_at:type_name -> google.protobuf.Timestamp
	30,  // 26: state.v1.Mapping.fields:type_name -> state.v1.MappingField
	165, // 27: state.v1.Mapping.created_at:type_name -> google.protobuf.Timestamp
	165, // 28: state.v1.Mapping.updated_at:type_name -> google.protobuf.Timestamp
	165, // 29: state.v1.Mapping.last_matched_at:type_name -> google.protobuf.Timestamp
	32,  // 30: state.v1.Binding.matcher:type_name -> state.v1.BindingMatcher
	165, // 31: state.v1.Binding.created_at:type_name -> google.protobuf.Timestamp
	165, // 32: state.v1.Binding.updated_at:type_name -> google.protobuf.Timestamp
	24,  // 33: state.v1.EnqueueChatTaskResponse.task:type_name -> state.v1.Task
	24,  // 34: state.v1.ClaimNextResponse.task:type_name -> state.v1.Task
	24,  // 35: state.v1.ClaimByIssueResponse.task:type_name -> state.v1.Task
	24,  // 36: state.v1.UpdateRequest.task:type_name -> state.v1.Task
	25,  // 37: state.v1.ArchiveTaskRequest.audit:type_name -> state.v1.Event
	24,  // 38: state.v1.TaskByIssueResponse.task:type_name -> state.v1.Task
	24,  // 39: state.v1.OpenTaskByPRResponse.task:type_name -> state.v1.Task
	24,  // 40: state.v1.TaskByIDResponse.task:type_name -> state.v1.Task
	24,  // 41: state.v1.OpenPRsResponse.tasks:type_name -> state.v1.Task
	24,  // 42: state.v1.TasksResponse.tasks:type_name -> state.v1.Task
	164, // 43: state.v1.StatusCountsResponse.counts:type_name -> state.v1.StatusCountsResponse.CountsEntry
	25,  // 44: state.v1.InsertEventRequest.event:type_name -> state.v1.Event
	25,  // 45: state.v1.EventsSinceResponse.events:type_name -> state.v1.Event
	25,  // 46: state.v1.TaskEventsResponse.events:type_name -> state.v1.Event
	34,  // 47: state.v1.WorkflowStatsResponse.stats:type_name -> state.v1.WorkflowStat
	35,  // 48: state.v1.StageStatsResponse.stats:type_name -> state.v1.StageStat
	36,  // 49: state.v1.TokensByDayResponse.tokens:type_name -> state.v1.DayTokens
	165, // 50: state.v1.ConfigSnapshot.published_at:type_name -> google.protobuf.Timestamp
	91,  // 51: state.v1.PutConfigSnapshotRequest.snapshot:type_name -> state.v1.ConfigSnapshot
	91,  // 52: state.v1.GetConfigSnapshotResponse.snapshot:type_name -> state.v1.ConfigSnapshot
	165, // 53: state.v1.ChannelStatus.observed_at:type_name -> google.protobuf.Timestamp
	96,  // 54: state.v1.PutChannelStatusRequest.channels:type_name -> state.v1.ChannelStatus
	96,  // 55: state.v1.ListChannelStatusResponse.channels:type_name -> state.v1.ChannelStatus
	165, // 56: state.v1.ApplyStatus.reported_at:type_name -> google.protobuf.Timestamp
	101, // 57: state.v1.PutApplyStatusRequest.status:type_name -> state.v1.ApplyStatus
	101, // 58: state.v1.ListApplyStatusResponse.statuses:type_name -> state.v1.ApplyStatus
	165, // 59: state.v1.TaskLogEntry.time:type_name -> google.protobuf.Timestamp
	165, // 60: state.v1.ReadTaskLogRequest.since:type_name -> google.protobuf.Timestamp
	165, // 61: state.v1.ReadTaskLogRequest.until:type_name -> google.protobuf.Timestamp
	106, // 62: state.v1.ReadTaskLogResponse.entries:type_name -> state.v1.TaskLogEntry
	26,  // 63: state.v1.InsertCaptureRequest.capture:type_name -> state.v1.CapturedEvent
	26,  // 64: state.v1.ListCapturesResponse.captures:type_name -> state.v1.CapturedEvent
	26,  // 65: state.v1.StreamCapturesResponse.capture:type_name -> state.v1.CapturedEvent
	31,  // 66: state.v1.InsertMappingRequest.mapping:type_name -> state.v1.Mapping
	31,  // 67: state.v1.GetMappingResponse.mapping:type_name -> state.v1.Mapping
	31,  // 68: state.v1.ListMappingsResponse.mappings:type_name -> state.v1.Mapping
	31,  // 69: state.v1.UpdateMappingRequest.mapping:type_name -> state.v1.Mapping
	29,  // 70: state.v1.InsertEventTypeRequest.event_type:type_name -> state.v1.EventType
	29,  // 71: state.v1.UpdateEventTypeRequest.event_type:type_name -> state.v1.EventType
	29,  // 72: state.v1.ListEventTypesResponse.event_types:type_name -> state.v1.EventType
	33,  // 73: state.v1.InsertBindingRequest.binding:type_name -> state.v1.Binding
	33,  // 74: state.v1.GetBindingResponse.binding:type_name -> state.v1.Binding
	33,  // 75: state.v1.ListBindingsResponse.bindings:type_name -> state.v1.Binding
	33,  // 76: state.v1.UpdateBindingRequest.binding:type_name -> state.v1.Binding
	33,  // 77: state.v1.ArmedBindingsForSourceResponse.bindings:type_name -> state.v1.Binding
	26,  // 78: state.v1.ListUndispatchedCapturesResponse.captures:type_name -> state.v1.CapturedEvent
	26,  // 79: state.v1.StreamUndispatchedCapturesResponse.capture:type_name -> state.v1.CapturedEvent
	24,  // 80: state.v1.EnqueueBindingTaskResponse.task:type_name -> state.v1.Task
	0,   // 81: state.v1.StateStoreService.RegisterTaskGrant:input_type -> state.v1.RegisterTaskGrantRequest
	2,   // 82: state.v1.StateStoreService.RevokeTaskGrant:input_type -> state.v1.RevokeTaskGrantRequest
	6,   // 83: state.v1.StateStoreService.ListIdentities:input_type -> state.v1.ListIdentitiesRequest
	8,   // 84: state.v1.StateStoreService.GetIdentity:input_type -> state.v1.GetIdentityRequest
	10,  // 85: state.v1.StateStoreService.CreateIdentity:input_type -> state.v1.CreateIdentityRequest
	11,  // 86: state.v1.StateStoreService.RenameIdentity:input_type -> state.v1.RenameIdentityRequest
	12,  // 87: state.v1.StateStoreService.SuspendIdentity:input_type -> state.v1.SuspendIdentityRequest
	13,  // 88: state.v1.StateStoreService.ReactivateIdentity:input_type -> state.v1.ReactivateIdentityRequest
	14,  // 89: state.v1.StateStoreService.RetireIdentity:input_type -> state.v1.RetireIdentityRequest
	20,  // 90: state.v1.StateStoreService.ResolveIdentitySubject:input_type -> state.v1.ResolveIdentitySubjectRequest
	22,  // 91: state.v1.StateStoreService.BindIdentitySubject:input_type -> state.v1.BindIdentitySubjectRequest
	37,  // 92: state.v1.StateStoreService.EnqueueIssue:input_type -> state.v1.EnqueueIssueRequest
	39,  // 93: state.v1.StateStoreService.EnqueueChatTask:input_type -> state.v1.EnqueueChatTaskRequest
	41,  // 94: state.v1.StateStoreService.ClaimNext:input_type -> state.v1.ClaimNextRequest
	43,  // 95: state.v1.StateStoreService.ClaimByIssue:input_type -> state.v1.ClaimByIssueRequest
	45,  // 96: state.v1.StateStoreService.Transition:input_type -> state.v1.TransitionRequest
	47,  // 97: state.v1.StateStoreService.Update:input_type -> state.v1.UpdateRequest
	49,  // 98: state.v1.StateStoreService.Requeue:input_type -> state.v1.RequeueRequest
	51,  // 99: state.v1.StateStoreService.ParkTask:input_type -> state.v1.ParkTaskRequest
	53,  // 100: state.v1.StateStoreService.RecoverStale:input_type -> state.v1.RecoverStaleRequest
	55,  // 101: state.v1.StateStoreService.ArchiveTask:input_type -> state.v1.ArchiveTaskRequest
	57,  // 102: state.v1.StateStoreService.RetryTask:input_type -> state.v1.RetryTaskRequest
	59,  // 103: state.v1.StateStoreService.BeginRemediation:input_type -> state.v1.BeginRemediationRequest
	61,  // 104: state.v1.StateStoreService.UpdateReviewPayload:input_type -> state.v1.UpdateReviewPayloadRequest
	63,  // 105: state.v1.StateStoreService.SetReviewCursors:input_type -> state.v1.SetReviewCursorsRequest
	65,  // 106: state.v1.StateStoreService.TaskByIssue:input_type -> state.v1.TaskByIssueRequest
	67,  // 107: state.v1.StateStoreService.OpenTaskByPR:input_type -> state.v1.OpenTaskByPRRequest
	69,  // 108: state.v1.StateStoreService.TaskByID:input_type -> state.v1.TaskByIDRequest
	71,  // 109: state.v1.StateStoreService.OpenPRs:input_type -> state.v1.OpenPRsRequest
	73,  // 110: state.v1.StateStoreService.ClearTerminalTasks:input_type -> state.v1.ClearTerminalTasksRequest
	75,  // 111: state.v1.StateStoreService.Tasks:input_type -> state.v1.TasksRequest
	77,  // 112: state.v1.StateStoreService.StatusCounts:input_type -> state.v1.StatusCountsRequest
	79,  // 113: state.v1.StateStoreService.InsertEvent:input_type -> state.v1.InsertEventRequest
	81,  // 114: state.v1.StateStoreService.EventsSince:input_type -> state.v1.EventsSinceRequest
	83,  // 115: state.v1.StateStoreService.TaskEvents:input_type -> state.v1.TaskEventsRequest
	85,  // 116: state.v1.StateStoreService.WorkflowStats:input_type -> state.v1.WorkflowStatsRequest
	87,  // 117: state.v1.StateStoreService.StageStats:input_type -> state.v1.StageStatsRequest
	89,  // 118: state.v1.StateStoreService.TokensByDay:input_type -> state.v1.TokensByDayRequest
	92,  // 119: state.v1.StateStoreService.PutConfigSnapshot:input_type -> state.v1.PutConfigSnapshotRequest
	94,  // 120: state.v1.StateStoreService.GetConfigSnapshot:input_type -> state.v1.GetConfigSnapshotRequest
	97,  // 121: state.v1.StateStoreService.PutChannelStatus:input_type -> state.v1.PutChannelStatusRequest
	99,  // 122: state.v1.StateStoreService.ListChannelStatus:input_type -> state.v1.ListChannelStatusRequest
	102, // 123: state.v1.StateStoreService.PutApplyStatus:input_type -> state.v1.PutApplyStatusRequest
	104, // 124: state.v1.StateStoreService.ListApplyStatus:input_type -> state.v1.ListApplyStatusRequest
	107, // 125: state.v1.StateStoreService.ReadTaskLog:input_type -> state.v1.ReadTaskLogRequest
	109, // 126: state.v1.StateStoreService.StreamTaskLogContent:input_type -> state.v1.StreamTaskLogContentRequest
	111, // 127: state.v1.StateStoreService.InsertCapture:input_type -> state.v1.InsertCaptureRequest
	113, // 128: state.v1.StateStoreService.ListCaptures:input_type -> state.v1.ListCapturesRequest
	115, // 129: state.v1.StateStoreService.StreamCaptures:input_type -> state.v1.StreamCapturesRequest
	117, // 130: state.v1.StateStoreService.InsertMapping:input_type -> state.v1.InsertMappingRequest
	119, // 131: state.v1.StateStoreService.GetMapping:input_type -> state.v1.GetMappingRequest
	121, // 132: state.v1.StateStoreService.ListMappings:input_type -> state.v1.ListMappingsRequest
	123, // 133: state.v1.StateStoreService.UpdateMapping:input_type -> state.v1.UpdateMappingRequest
	125, // 134: state.v1.StateStoreService.DeleteMapping:input_type -> state.v1.DeleteMappingRequest
	127, // 135: state.v1.StateStoreService.RecordMappingMatch:input_type -> state.v1.RecordMappingMatchRequest
	129, // 136: state.v1.StateStoreService.InsertEventType:input_type -> state.v1.InsertEventTypeRequest
	131, // 137: state.v1.StateStoreService.UpdateEventType:input_type -> state.v1.UpdateEventTypeRequest
	133, // 138: state.v1.StateStoreService.DeleteEventType:input_type -> state.v1.DeleteEventTypeRequest
	135, // 139: state.v1.StateStoreService.ListEventTypes:input_type -> state.v1.ListEventTypesRequest
	137, // 140: state.v1.StateStoreService.InsertBinding:input_type -> state.v1.InsertBindingRequest
	139, // 141: state.v1.StateStoreService.GetBinding:input_type -> state.v1.GetBindingRequest
	141, // 142: state.v1.StateStoreService.ListBindings:input_type -> state.v1.ListBindingsRequest
	143, // 143: state.v1.StateStoreService.UpdateBinding:input_type -> state.v1.UpdateBindingRequest
	145, // 144: state.v1.StateStoreService.DeleteBinding:input_type -> state.v1.DeleteBindingRequest
	147, // 145: state.v1.StateStoreService.ApproveBinding:input_type -> state.v1.ApproveBindingRequest
	149, // 146: state.v1.StateStoreService.ArmedBindingsForSource:input_type -> state.v1.ArmedBindingsForSourceRequest
	151, // 147: state.v1.StateStoreService.RecordDispatch:input_type -> state.v1.RecordDispatchRequest
	153, // 148: state.v1.StateStoreService.RecordPlaybookDispatch:input_type -> state.v1.RecordPlaybookDispatchRequest
	155, // 149: state.v1.StateStoreService.DeletePlaybookDispatches:input_type -> state.v1.DeletePlaybookDispatchesRequest
	157, // 150: state.v1.StateStoreService.ListUndispatchedCaptures:input_type -> state.v1.ListUndispatchedCapturesRequest
	159, // 151: state.v1.StateStoreService.StreamUndispatchedCaptures:input_type -> state.v1.StreamUndispatchedCapturesRequest
	161, // 152: state.v1.StateStoreService.EnqueueBindingTask:input_type -> state.v1.EnqueueBindingTaskRequest
	1,   // 153: state.v1.StateStoreService.RegisterTaskGrant:output_type -> state.v1.RegisterTaskGrantResponse
	3,   // 154: state.v1.StateStoreService.RevokeTaskGrant:output_type -> state.v1.RevokeTaskGrantResponse
	7,   // 155: state.v1.StateStoreService.ListIdentities:output_type -> state.v1.ListIdentitiesResponse
	9,   // 156: state.v1.StateStoreService.GetIdentity:output_type -> state.v1.GetIdentityResponse
	15,  // 157: state.v1.StateStoreService.CreateIdentity:output_type -> state.v1.CreateIdentityResponse
	16,  // 158: state.v1.StateStoreService.RenameIdentity:output_type -> state.v1.RenameIdentityResponse
	17,  // 159: state.v1.StateStoreService.SuspendIdentity:output_type -> state.v1.SuspendIdentityResponse
	18,  // 160: state.v1.StateStoreService.ReactivateIdentity:output_type -> state.v1.ReactivateIdentityResponse
	19,  // 161: state.v1.StateStoreService.RetireIdentity:output_type -> state.v1.RetireIdentityResponse
	21,  // 162: state.v1.StateStoreService.ResolveIdentitySubject:output_type -> state.v1.ResolveIdentitySubjectResponse
	23,  // 163: state.v1.StateStoreService.BindIdentitySubject:output_type -> state.v1.BindIdentitySubjectResponse
	38,  // 164: state.v1.StateStoreService.EnqueueIssue:output_type -> state.v1.EnqueueIssueResponse
	40,  // 165: state.v1.StateStoreService.EnqueueChatTask:output_type -> state.v1.EnqueueChatTaskResponse
	42,  // 166: state.v1.StateStoreService.ClaimNext:output_type -> state.v1.ClaimNextResponse
	44,  // 167: state.v1.StateStoreService.ClaimByIssue:output_type -> state.v1.ClaimByIssueResponse
	46,  // 168: state.v1.StateStoreService.Transition:output_type -> state.v1.TransitionResponse
	48,  // 169: state.v1.StateStoreService.Update:output_type -> state.v1.UpdateResponse
	50,  // 170: state.v1.StateStoreService.Requeue:output_type -> state.v1.RequeueResponse
	52,  // 171: state.v1.StateStoreService.ParkTask:output_type -> state.v1.ParkTaskResponse
	54,  // 172: state.v1.StateStoreService.RecoverStale:output_type -> state.v1.RecoverStaleResponse
	56,  // 173: state.v1.StateStoreService.ArchiveTask:output_type -> state.v1.ArchiveTaskResponse
	58,  // 174: state.v1.StateStoreService.RetryTask:output_type -> state.v1.RetryTaskResponse
	60,  // 175: state.v1.StateStoreService.BeginRemediation:output_type -> state.v1.BeginRemediationResponse
	62,  // 176: state.v1.StateStoreService.UpdateReviewPayload:output_type -> state.v1.UpdateReviewPayloadResponse
	64,  // 177: state.v1.StateStoreService.SetReviewCursors:output_type -> state.v1.SetReviewCursorsResponse
	66,  // 178: state.v1.StateStoreService.TaskByIssue:output_type -> state.v1.TaskByIssueResponse
	68,  // 179: state.v1.StateStoreService.OpenTaskByPR:output_type -> state.v1.OpenTaskByPRResponse
	70,  // 180: state.v1.StateStoreService.TaskByID:output_type -> state.v1.TaskByIDResponse
	72,  // 181: state.v1.StateStoreService.OpenPRs:output_type -> state.v1.OpenPRsResponse
	74,  // 182: state.v1.StateStoreService.ClearTerminalTasks:output_type -> state.v1.ClearTerminalTasksResponse
	76,  // 183: state.v1.StateStoreService.Tasks:output_type -> state.v1.TasksResponse
	78,  // 184: state.v1.StateStoreService.StatusCounts:output_type -> state.v1.StatusCountsResponse
	80,  // 185: state.v1.StateStoreService.InsertEvent:output_type -> state.v1.InsertEventResponse
	82,  // 186: state.v1.StateStoreService.EventsSince:output_type -> state.v1.EventsSinceResponse
	84,  // 187: state.v1.StateStoreService.TaskEvents:output_type -> state.v1.TaskEventsResponse
	86,  // 188: state.v1.StateStoreService.WorkflowStats:output_type -> state.v1.WorkflowStatsResponse
	88,  // 189: state.v1.StateStoreService.StageStats:output_type -> state.v1.StageStatsResponse
	90,  // 190: state.v1.StateStoreService.TokensByDay:output_type -> state.v1.TokensByDayResponse
	93,  // 191: state.v1.StateStoreService.PutConfigSnapshot:output_type -> state.v1.PutConfigSnapshotResponse
	95,  // 192: state.v1.StateStoreService.GetConfigSnapshot:output_type -> state.v1.GetConfigSnapshotResponse
	98,  // 193: state.v1.StateStoreService.PutChannelStatus:output_type -> state.v1.PutChannelStatusResponse
	100, // 194: state.v1.StateStoreService.ListChannelStatus:output_type -> state.v1.ListChannelStatusResponse
	103, // 195: state.v1.StateStoreService.PutApplyStatus:output_type -> state.v1.PutApplyStatusResponse
	105, // 196: state.v1.StateStoreService.ListApplyStatus:output_type -> state.v1.ListApplyStatusResponse
	108, // 197: state.v1.StateStoreService.ReadTaskLog:output_type -> state.v1.ReadTaskLogResponse
	110, // 198: state.v1.StateStoreService.StreamTaskLogContent:output_type -> state.v1.StreamTaskLogContentResponse
	112, // 199: state.v1.StateStoreService.InsertCapture:output_type -> state.v1.InsertCaptureResponse
	114, // 200: state.v1.StateStoreService.ListCaptures:output_type -> state.v1.ListCapturesResponse
	116, // 201: state.v1.StateStoreService.StreamCaptures:output_type -> state.v1.StreamCapturesResponse
	118, // 202: state.v1.StateStoreService.InsertMapping:output_type -> state.v1.InsertMappingResponse
	120, // 203: state.v1.StateStoreService.GetMapping:output_type -> state.v1.GetMappingResponse
	122, // 204: state.v1.StateStoreService.ListMappings:output_type -> state.v1.ListMappingsResponse
	124, // 205: state.v1.StateStoreService.UpdateMapping:output_type -> state.v1.UpdateMappingResponse
	126, // 206: state.v1.StateStoreService.DeleteMapping:output_type -> state.v1.DeleteMappingResponse
	128, // 207: state.v1.StateStoreService.RecordMappingMatch:output_type -> state.v1.RecordMappingMatchResponse
	130, // 208: state.v1.StateStoreService.InsertEventType:output_type -> state.v1.InsertEventTypeResponse
	132, // 209: state.v1.StateStoreService.UpdateEventType:output_type -> state.v1.UpdateEventTypeResponse
	134, // 210: state.v1.StateStoreService.DeleteEventType:output_type -> state.v1.DeleteEventTypeResponse
	136, // 211: state.v1.StateStoreService.ListEventTypes:output_type -> state.v1.ListEventTypesResponse
	138, // 212: state.v1.StateStoreService.InsertBinding:output_type -> state.v1.InsertBindingResponse
	140, // 213: state.v1.StateStoreService.GetBinding:output_type -> state.v1.GetBindingResponse
	142, // 214: state.v1.StateStoreService.ListBindings:output_type -> state.v1.ListBindingsResponse
	144, // 215: state.v1.StateStoreService.UpdateBinding:output_type -> state.v1.UpdateBindingResponse
	146, // 216: state.v1.StateStoreService.DeleteBinding:output_type -> state.v1.DeleteBindingResponse
	148, // 217: state.v1.StateStoreService.ApproveBinding:output_type -> state.v1.ApproveBindingResponse
	150, // 218: state.v1.StateStoreService.ArmedBindingsForSource:output_type -> state.v1.ArmedBindingsForSourceResponse
	152, // 219: state.v1.StateStoreService.RecordDispatch:output_type -> state.v1.RecordDispatchResponse
	154, // 220: state.v1.StateStoreService.RecordPlaybookDispatch:output_type -> state.v1.RecordPlaybookDispatchResponse
	156, // 221: state.v1.StateStoreService.DeletePlaybookDispatches:output_type -> state.v1.DeletePlaybookDispatchesResponse
	158, // 222: state.v1.StateStoreService.ListUndispatchedCaptures:output_type -> state.v1.ListUndispatchedCapturesResponse
	160, // 223: state.v1.StateStoreService.StreamUndispatchedCaptures:output_type -> state.v1.StreamUndispatchedCapturesResponse
	162, // 224: state.v1.StateStoreService.EnqueueBindingTask:output_type -> state.v1.EnqueueBindingTaskResponse
	153, // [153:225] is the sub-list for method output_type
	81,  // [81:153] is the sub-list for method input_type
