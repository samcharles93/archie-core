...
const file_state_v1_state_proto_rawDesc = "" +
	...
	"\x04task\x18\x01 \x01(\v2\x0e.state.v1.TaskR\x04task2\xfb+\n" +
...
var file_state_v1_state_proto_msgTypes = make([]protoimpl.MessageInfo, 149)
var file_state_v1_state_proto_goTypes = []any{
	...
	(*RecoverStaleRequest)(nil),                // 48: state.v1.RecoverStaleRequest
	(*RecoverStaleResponse)(nil),               // 49: state.v1.RecoverStaleResponse
	(*ArchiveTaskRequest)(nil),                 // 50: state.v1.ArchiveTaskRequest
	(*ArchiveTaskResponse)(nil),                // 51: state.v1.ArchiveTaskResponse
	(*RetryTaskRequest)(nil),                   // 52: state.v1.RetryTaskRequest
	(*RetryTaskResponse)(nil),                  // 53: state.v1.RetryTaskResponse
	(*BeginRemediationRequest)(nil),            // 54: state.v1.BeginRemediationRequest
	(*BeginRemediationResponse)(nil),           // 55: state.v1.BeginRemediationResponse
	(*UpdateReviewPayloadRequest)(nil),         // 56: state.v1.UpdateReviewPayloadRequest
	(*UpdateReviewPayloadResponse)(nil),        // 57: state.v1.UpdateReviewPayloadResponse
	(*SetReviewCursorsRequest)(nil),            // 58: state.v1.SetReviewCursorsRequest
	(*SetReviewCursorsResponse)(nil),           // 59: state.v1.SetReviewCursorsResponse
	(*TaskByIssueRequest)(nil),                 // 60: state.v1.TaskByIssueRequest
	(*TaskByIssueResponse)(nil),                // 61: state.v1.TaskByIssueResponse
	(*OpenTaskByPRRequest)(nil),                // 62: state.v1.OpenTaskByPRRequest
	(*OpenTaskByPRResponse)(nil),               // 63: state.v1.OpenTaskByPRResponse
	(*TaskByIDRequest)(nil),                    // 64: state.v1.TaskByIDRequest
	(*TaskByIDResponse)(nil),                   // 65: state.v1.TaskByIDResponse
	(*OpenPRsRequest)(nil),                     // 66: state.v1.OpenPRsRequest
	(*OpenPRsResponse)(nil),                    // 67: state.v1.OpenPRsResponse
	(*ClearTerminalTasksRequest)(nil),          // 68: state.v1.ClearTerminalTasksRequest
	(*ClearTerminalTasksResponse)(nil),         // 69: state.v1.ClearTerminalTasksResponse
	(*TasksRequest)(nil),                       // 70: state.v1.TasksRequest
	(*TasksResponse)(nil),                      // 71: state.v1.TasksResponse
	(*StatusCountsRequest)(nil),                // 72: state.v1.StatusCountsRequest
	(*StatusCountsResponse)(nil),               // 73: state.v1.StatusCountsResponse
	(*InsertEventRequest)(nil),                 // 74: state.v1.InsertEventRequest
	(*InsertEventResponse)(nil),                // 75: state.v1.InsertEventResponse
	(*EventsSinceRequest)(nil),                 // 76: state.v1.EventsSinceRequest
	(*EventsSinceResponse)(nil),                // 77: state.v1.EventsSinceResponse
	(*TaskEventsRequest)(nil),                  // 78: state.v1.TaskEventsRequest
	(*TaskEventsResponse)(nil),                 // 79: state.v1.TaskEventsResponse
	(*WorkflowStatsRequest)(nil),               // 80: state.v1.WorkflowStatsRequest
	(*WorkflowStatsResponse)(nil),              // 81: state.v1.WorkflowStatsResponse
	(*StageStatsRequest)(nil),                  // 82: state.v1.StageStatsRequest
	(*StageStatsResponse)(nil),                 // 83: state.v1.StageStatsResponse
	(*TokensByDayRequest)(nil),                 // 84: state.v1.TokensByDayRequest
	(*TokensByDayResponse)(nil),                // 85: state.v1.TokensByDayResponse
	(*ConfigSnapshot)(nil),                     // 86: state.v1.ConfigSnapshot
	(*PutConfigSnapshotRequest)(nil),           // 87: state.v1.PutConfigSnapshotRequest
	(*PutConfigSnapshotResponse)(nil),          // 88: state.v1.PutConfigSnapshotResponse
	(*GetConfigSnapshotRequest)(nil),           // 89: state.v1.GetConfigSnapshotRequest
	(*GetConfigSnapshotResponse)(nil),          // 90: state.v1.GetConfigSnapshotResponse
	(*ChannelStatus)(nil),                      // 91: state.v1.ChannelStatus
	(*PutChannelStatusRequest)(nil),            // 92: state.v1.PutChannelStatusRequest
	(*PutChannelStatusResponse)(nil),           // 93: state.v1.PutChannelStatusResponse
	(*ListChannelStatusRequest)(nil),           // 94: state.v1.ListChannelStatusRequest
	(*ListChannelStatusResponse)(nil),          // 95: state.v1.ListChannelStatusResponse
	(*ApplyStatus)(nil),                        // 96: state.v1.ApplyStatus
	(*PutApplyStatusRequest)(nil),              // 97: state.v1.PutApplyStatusRequest
	(*PutApplyStatusResponse)(nil),             // 98: state.v1.PutApplyStatusResponse
	(*ListApplyStatusRequest)(nil),             // 99: state.v1.ListApplyStatusRequest
	(*ListApplyStatusResponse)(nil),            // 100: state.v1.ListApplyStatusResponse
	(*TaskLogEntry)(nil),                       // 101: state.v1.TaskLogEntry
	(*ReadTaskLogRequest)(nil),                 // 102: state.v1.ReadTaskLogRequest
	(*ReadTaskLogResponse)(nil),                // 103: state.v1.ReadTaskLogResponse
	(*StreamTaskLogContentRequest)(nil),        // 104: state.v1.StreamTaskLogContentRequest
	(*StreamTaskLogContentResponse)(nil),       // 105: state.v1.StreamTaskLogContentResponse
	(*InsertCaptureRequest)(nil),               // 106: state.v1.InsertCaptureRequest
	(*InsertCaptureResponse)(nil),              // 107: state.v1.InsertCaptureResponse
	(*ListCapturesRequest)(nil),                // 108: state.v1.ListCapturesRequest
	(*ListCapturesResponse)(nil),               // 109: state.v1.ListCapturesResponse
	(*StreamCapturesRequest)(nil),              // 110: state.v1.StreamCapturesRequest
	(*StreamCapturesResponse)(nil),             // 111: state.v1.StreamCapturesResponse
	(*InsertMappingRequest)(nil),               // 112: state.v1.InsertMappingRequest
	(*InsertMappingResponse)(nil),              // 113: state.v1.InsertMappingResponse
	(*GetMappingRequest)(nil),                  // 114: state.v1.GetMappingRequest
	(*GetMappingResponse)(nil),                 // 115: state.v1.GetMappingResponse
	(*ListMappingsRequest)(nil),                // 116: state.v1.ListMappingsRequest
	(*ListMappingsResponse)(nil),               // 117: state.v1.ListMappingsResponse
	(*UpdateMappingRequest)(nil),               // 118: state.v1.UpdateMappingRequest
	(*UpdateMappingResponse)(nil),              // 119: state.v1.UpdateMappingResponse
	(*DeleteMappingRequest)(nil),               // 120: state.v1.DeleteMappingRequest
	(*DeleteMappingResponse)(nil),              // 121: state.v1.DeleteMappingResponse
	(*InsertBindingRequest)(nil),               // 122: state.v1.InsertBindingRequest
	(*InsertBindingResponse)(nil),              // 123: state.v1.InsertBindingResponse
	(*GetBindingRequest)(nil),                  // 124: state.v1.GetBindingRequest
	(*GetBindingResponse)(nil),                 // 125: state.v1.GetBindingResponse
	(*ListBindingsRequest)(nil),                // 126: state.v1.ListBindingsRequest
	(*ListBindingsResponse)(nil),               // 127: state.v1.ListBindingsResponse
	(*UpdateBindingRequest)(nil),               // 128: state.v1.UpdateBindingRequest
	(*UpdateBindingResponse)(nil),              // 129: state.v1.UpdateBindingResponse
	(*DeleteBindingRequest)(nil),               // 130: state.v1.DeleteBindingRequest
	(*DeleteBindingResponse)(nil),              // 131: state.v1.DeleteBindingResponse
	(*ApproveBindingRequest)(nil),              // 132: state.v1.ApproveBindingRequest
	(*ApproveBindingResponse)(nil),             // 133: state.v1.ApproveBindingResponse
	(*ArmedBindingsForSourceRequest)(nil),      // 134: state.v1.ArmedBindingsForSourceRequest
	(*ArmedBindingsForSourceResponse)(nil),     // 135: state.v1.ArmedBindingsForSourceResponse
	(*RecordDispatchRequest)(nil),              // 136: state.v1.RecordDispatchRequest
	(*RecordDispatchResponse)(nil),             // 137: state.v1.RecordDispatchResponse
	(*RecordPlaybookDispatchRequest)(nil),      // 138: state.v1.RecordPlaybookDispatchRequest
	(*RecordPlaybookDispatchResponse)(nil),     // 139: state.v1.RecordPlaybookDispatchResponse
	(*DeletePlaybookDispatchesRequest)(nil),    // 140: state.v1.DeletePlaybookDispatchesRequest
	(*DeletePlaybookDispatchesResponse)(nil),   // 141: state.v1.DeletePlaybookDispatchesResponse
	(*ListUndispatchedCapturesRequest)(nil),    // 142: state.v1.ListUndispatchedCapturesRequest
	(*ListUndispatchedCapturesResponse)(nil),   // 143: state.v1.ListUndispatchedCapturesResponse
	(*StreamUndispatchedCapturesRequest)(nil),  // 144: state.v1.StreamUndispatchedCapturesRequest
	(*StreamUndispatchedCapturesResponse)(nil), // 145: state.v1.StreamUndispatchedCapturesResponse
	(*EnqueueBindingTaskRequest)(nil),          // 146: state.v1.EnqueueBindingTaskRequest
	(*EnqueueBindingTaskResponse)(nil),         // 147: state.v1.EnqueueBindingTaskResponse
	nil,                                        // 148: state.v1.StatusCountsResponse.CountsEntry
	(*timestamppb.Timestamp)(nil),              // 149: google.protobuf.Timestamp
}
var file_state_v1_state_proto_depIdxs = []int32{
	149, // 0: state.v1.Identity.created_at:type_name -> google.protobuf.Timestamp
	149, // 1: state.v1.Identity.updated_at:type_name -> google.protobuf.Timestamp
	...
	149, // 17: state.v1.Task.created_at:type_name -> google.protobuf.Timestamp
	149, // 18: state.v1.Task.updated_at:type_name -> google.protobuf.Timestamp
	149, // 19: state.v1.Event.at:type_name -> google.protobuf.Timestamp
	149, // 20: state.v1.CapturedEvent.received_at:type_name -> google.protobuf.Timestamp
	27,  // 21: state.v1.Mapping.fields:type_name -> state.v1.MappingField
	149, // 22: state.v1.Mapping.created_at:type_name -> google.protobuf.Timestamp
	149, // 23: state.v1.Mapping.updated_at:type_name -> google.protobuf.Timestamp
	29,  // 24: state.v1.Binding.matcher:type_name -> state.v1.BindingMatcher
	149, // 25: state.v1.Binding.created_at:type_name -> google.protobuf.Timestamp
	149, // 26: state.v1.Binding.updated_at:type_name -> google.protobuf.Timestamp
	...
	148, // 37: state.v1.StatusCountsResponse.counts:type_name -> state.v1.StatusCountsResponse.CountsEntry
	...
	149, // 44: state.v1.ConfigSnapshot.published_at:type_name -> google.protobuf.Timestamp
	86,  // 45: state.v1.PutConfigSnapshotRequest.snapshot:type_name -> state.v1.ConfigSnapshot
	86,  // 46: state.v1.GetConfigSnapshotResponse.snapshot:type_name -> state.v1.ConfigSnapshot
	149, // 47: state.v1.ChannelStatus.observed_at:type_name -> google.protobuf.Timestamp
	91,  // 48: state.v1.PutChannelStatusRequest.channels:type_name -> state.v1.ChannelStatus
	91,  // 49: state.v1.ListChannelStatusResponse.channels:type_name -> state.v1.ChannelStatus
	149, // 50: state.v1.ApplyStatus.reported_at:type_name -> google.protobuf.Timestamp
	96,  // 51: state.v1.PutApplyStatusRequest.status:type_name -> state.v1.ApplyStatus
	96,  // 52: state.v1.ListApplyStatusResponse.statuses:type_name -> state.v1.ApplyStatus
	149, // 53: state.v1.TaskLogEntry.time:type_name -> google.protobuf.Timestamp
	149, // 54: state.v1.ReadTaskLogRequest.since:type_name -> google.protobuf.Timestamp
	149, // 55: state.v1.ReadTaskLogRequest.until:type_name -> google.protobuf.Timestamp
	101, // 56: state.v1.ReadTaskLogResponse.entries:type_name -> state.v1.TaskLogEntry
	...
	48,  // 90: state.v1.StateStoreService.RecoverStale:input_type -> state.v1.RecoverStaleRequest
	50,  // 91: state.v1.StateStoreService.ArchiveTask:input_type -> state.v1.ArchiveTaskRequest
	52,  // 92: state.v1.StateStoreService.RetryTask:input_type -> state.v1.RetryTaskRequest
	54,  // 93: state.v1.StateStoreService.BeginRemediation:input_type -> state.v1.BeginRemediationRequest
	56,  // 94: state.v1.StateStoreService.UpdateReviewPayload:input_type -> state.v1.UpdateReviewPayloadRequest
	58,  // 95: state.v1.StateStoreService.SetReviewCursors:input_type -> state.v1.SetReviewCursorsRequest
	60,  // 96: state.v1.StateStoreService.TaskByIssue:input_type -> state.v1.TaskByIssueRequest
	62,  // 97: state.v1.StateStoreService.OpenTaskByPR:input_type -> state.v1.OpenTaskByPRRequest
	64,  // 98: state.v1.StateStoreService.TaskByID:input_type -> state.v1.TaskByIDRequest
	66,  // 99: state.v1.StateStoreService.OpenPRs:input_type -> state.v1.OpenPRsRequest
	68,  // 100: state.v1.StateStoreService.ClearTerminalTasks:input_type -> state.v1.ClearTerminalTasksRequest
	70,  // 101: state.v1.StateStoreService.Tasks:input_type -> state.v1.TasksRequest
	72,  // 102: state.v1.StateStoreService.StatusCounts:input_type -> state.v1.StatusCountsRequest
	74,  // 103: state.v1.StateStoreService.InsertEvent:input_type -> state.v1.InsertEventRequest
	76,  // 104: state.v1.StateStoreService.EventsSince:input_type -> state.v1.EventsSinceRequest
	78,  // 105: state.v1.StateStoreService.TaskEvents:input_type -> state.v1.TaskEventsRequest
	80,  // 106: state.v1.StateStoreService.WorkflowStats:input_type -> state.v1.WorkflowStatsRequest
	82,  // 107: state.v1.StateStoreService.StageStats:input_type -> state.v1.StageStatsRequest
	84,  // 108: state.v1.StateStoreService.TokensByDay:input_type -> state.v1.TokensByDayRequest
	87,  // 109: state.v1.StateStoreService.PutConfigSnapshot:input_type -> state.v1.PutConfigSnapshotRequest
	89,  // 110: state.v1.StateStoreService.GetConfigSnapshot:input_type -> state.v1.GetConfigSnapshotRequest
	92,  // 111: state.v1.StateStoreService.PutChannelStatus:input_type -> state.v1.PutChannelStatusRequest
	94,  // 112: state.v1.StateStoreService.ListChannelStatus:input_type -> state.v1.ListChannelStatusRequest
	97,  // 113: state.v1.StateStoreService.PutApplyStatus:input_type -> state.v1.PutApplyStatusRequest
	99,  // 114: state.v1.StateStoreService.ListApplyStatus:input_type -> state.v1.ListApplyStatusRequest
	102, // 115: state.v1.StateStoreService.ReadTaskLog:input_type -> state.v1.ReadTaskLogRequest
	104, // 116: state.v1.StateStoreService.StreamTaskLogContent:input_type -> state.v1.StreamTaskLogContentRequest
	106, // 117: state.v1.StateStoreService.InsertCapture:input_type -> state.v1.InsertCaptureRequest
	108, // 118: state.v1.StateStoreService.ListCaptures:input_type -> state.v1.ListCapturesRequest
	110, // 119: state.v1.StateStoreService.StreamCaptures:input_type -> state.v1.StreamCapturesRequest
	112, // 120: state.v1.StateStoreService.InsertMapping:input_type -> state.v1.InsertMappingRequest
	114, // 121: state.v1.StateStoreService.GetMapping:input_type -> state.v1.GetMappingRequest
	116, // 122: state.v1.StateStoreService.ListMappings:input_type -> state.v1.ListMappingsRequest
	118, // 123: state.v1.StateStoreService.UpdateMapping:input_type -> state.v1.UpdateMappingRequest
	120, // 124: state.v1.StateStoreService.DeleteMapping:input_type -> state.v1.DeleteMappingRequest
	122, // 125: state.v1.StateStoreService.InsertBinding:input_type -> state.v1.InsertBindingRequest
	124, // 126: state.v1.StateStoreService.GetBinding:input_type -> state.v1.GetBindingRequest
	126, // 127: state.v1.StateStoreService.ListBindings:input_type -> state.v1.ListBindingsRequest
	128, // 128: state.v1.StateStoreService.UpdateBinding:input_type -> state.v1.UpdateBindingRequest
	130, // 129: state.v1.StateStoreService.DeleteBinding:input_type -> state.v1.DeleteBindingRequest
	132, // 130: state.v1.StateStoreService.ApproveBinding:input_type -> state.v1.ApproveBindingRequest
	134, // 131: state.v1.StateStoreService.ArmedBindingsForSource:input_type -> state.v1.ArmedBindingsForSourceRequest
	136, // 132: state.v1.StateStoreService.RecordDispatch:input_type -> state.v1.RecordDispatchRequest
	138, // 133: state.v1.StateStoreService.RecordPlaybookDispatch:input_type -> state.v1.RecordPlaybookDispatchRequest
	140, // 134: state.v1.StateStoreService.DeletePlaybookDispatches:input_type -> state.v1.DeletePlaybookDispatchesRequest
	142, // 135: state.v1.StateStoreService.ListUndispatchedCaptures:input_type -> state.v1.ListUndispatchedCapturesRequest
	144, // 136: state.v1.StateStoreService.StreamUndispatchedCaptures:input_type -> state.v1.StreamUndispatchedCapturesRequest
	146, // 137: state.v1.StateStoreService.EnqueueBindingTask:input_type -> state.v1.EnqueueBindingTaskRequest
	1,   // 138: state.v1.StateStoreService.RegisterTaskGrant:output_type -> state.v1.RegisterTaskGrantResponse
	3,   // 139: state.v1.StateStoreService.RevokeTaskGrant:output_type -> state.v1.RevokeTaskGrantResponse
	7,   // 140: state.v1.StateStoreService.ListIdentities:output_type -> state.v1.ListIdentitiesResponse
	9,   // 141: state.v1.StateStoreService.GetIdentity:output_type -> state.v1.GetIdentityResponse
	15,  // 142: state.v1.StateStoreService.CreateIdentity:output_type -> state.v1.CreateIdentityResponse
	16,  // 143: state.v1.StateStoreService.RenameIdentity:output_type -> state.v1.RenameIdentityResponse
	17,  // 144: state.v1.StateStoreService.SuspendIdentity:output_type -> state.v1.SuspendIdentityResponse
	18,  // 145: state.v1.StateStoreService.ReactivateIdentity:output_type -> state.v1.ReactivateIdentityResponse
	19,  // 146: state.v1.StateStoreService.RetireIdentity:output_type -> state.v1.RetireIdentityResponse
	21,  // 147: state.v1.StateStoreService.ResolveIdentitySubject:output_type -> state.v1.ResolveIdentitySubjectResponse
	23,  // 148: state.v1.StateStoreService.BindIdentitySubject:output_type -> state.v1.BindIdentitySubjectResponse
	35,  // 149: state.v1.StateStoreService.EnqueueIssue:output_type -> state.v1.EnqueueIssueResponse
	37,  // 150: state.v1.StateStoreService.EnqueueChatTask:output_type -> state.v1.EnqueueChatTaskResponse
	39,  // 151: state.v1.StateStoreService.ClaimNext:output_type -> state.v1.ClaimNextResponse
	41,  // 152: state.v1.StateStoreService.ClaimByIssue:output_type -> state.v1.ClaimByIssueResponse
	43,  // 153: state.v1.StateStoreService.Transition:output_type -> state.v1.TransitionResponse
	45,  // 154: state.v1.StateStoreService.Update:output_type -> state.v1.UpdateResponse
	47,  // 155: state.v1.StateStoreService.Requeue:output_type -> state.v1.RequeueResponse
	49,  // 156: state.v1.StateStoreService.RecoverStale:output_type -> state.v1.RecoverStaleResponse
	51,  // 157: state.v1.StateStoreService.ArchiveTask:output_type -> state.v1.ArchiveTaskResponse
	53,  // 158: state.v1.StateStoreService.RetryTask:output_type -> state.v1.RetryTaskResponse
	55,  // 159: state.v1.StateStoreService.BeginRemediation:output_type -> state.v1.BeginRemediationResponse
	57,  // 160: state.v1.StateStoreService.UpdateReviewPayload:output_type -> state.v1.UpdateReviewPayloadResponse
	59,  // 161: state.v1.StateStoreService.SetReviewCursors:output_type -> state.v1.SetReviewCursorsResponse
	61,  // 162: state.v1.StateStoreService.TaskByIssue:output_type -> state.v1.TaskByIssueResponse
	63,  // 163: state.v1.StateStoreService.OpenTaskByPR:output_type -> state.v1.OpenTaskByPRResponse
	65,  // 164: state.v1.StateStoreService.TaskByID:output_type -> state.v1.TaskByIDResponse
	67,  // 165: state.v1.StateStoreService.OpenPRs:output_type -> state.v1.OpenPRsResponse
	69,  // 166: state.v1.StateStoreService.ClearTerminalTasks:output_type -> state.v1.ClearTerminalTasksResponse
	71,  // 167: state.v1.StateStoreService.Tasks:output_type -> state.v1.TasksResponse
	73,  // 168: state.v1.StateStoreService.StatusCounts:output_type -> state.v1.StatusCountsResponse
	75,  // 169: state.v1.StateStoreService.InsertEvent:output_type -> state.v1.InsertEventResponse
	77,  // 170: state.v1.StateStoreService.EventsSince:output_type -> state.v1.EventsSinceResponse
	79,  // 171: state.v1.StateStoreService.TaskEvents:output_type -> state.v1.TaskEventsResponse
	81,  // 172: state.v1.StateStoreService.WorkflowStats:output_type -> state.v1.WorkflowStatsResponse
	83,  // 173: state.v1.StateStoreService.StageStats:output_type -> state.v1.StageStatsResponse
	85,  // 174: state.v1.StateStoreService.TokensByDay:output_type -> state.v1.TokensByDayResponse
	88,  // 175: state.v1.StateStoreService.PutConfigSnapshot:output_type -> state.v1.PutConfigSnapshotResponse
	90,  // 176: state.v1.StateStoreService.GetConfigSnapshot:output_type -> state.v1.GetConfigSnapshotResponse
	93,  // 177: state.v1.StateStoreService.PutChannelStatus:output_type -> state.v1.PutChannelStatusResponse
	95,  // 178: state.v1.StateStoreService.ListChannelStatus:output_type -> state.v1.ListChannelStatusResponse
	98,  // 179: state.v1.StateStoreService.PutApplyStatus:output_type -> state.v1.PutApplyStatusResponse
	100, // 180: state.v1.StateStoreService.ListApplyStatus:output_type -> state.v1.ListApplyStatusResponse
	103, // 181: state.v1.StateStoreService.ReadTaskLog:output_type -> state.v1.ReadTaskLogResponse
	105, // 182: state.v1.StateStoreService.StreamTaskLogContent:output_type -> state.v1.StreamTaskLogContentResponse
	107, // 183: state.v1.StateStoreService.InsertCapture:output_type -> state.v1.InsertCaptureResponse
	109, // 184: state.v1.StateStoreService.ListCaptures:output_type -> state.v1.ListCapturesResponse
	111, // 185: state.v1.StateStoreService.StreamCaptures:output_type -> state.v1.StreamCapturesResponse
	113, // 186: state.v1.StateStoreService.InsertMapping:output_type -> state.v1.InsertMappingResponse
	115, // 187: state.v1.StateStoreService.GetMapping:output_type -> state.v1.GetMappingResponse
	117, // 188: state.v1.StateStoreService.ListMappings:output_type -> state.v1.ListMappingsResponse
	119, // 189: state.v1.StateStoreService.UpdateMapping:output_type -> state.v1.UpdateMappingResponse
	121, // 190: state.v1.StateStoreService.DeleteMapping:output_type -> state.v1.DeleteMappingResponse
	123, // 191: state.v1.StateStoreService.InsertBinding:output_type -> state.v1.InsertBindingResponse
	125, // 192: state.v1.StateStoreService.GetBinding:output_type -> state.v1.GetBindingResponse
	127, // 193: state.v1.StateStoreService.ListBindings:output_type -> state.v1.ListBindingsResponse
	129, // 194: state.v1.StateStoreService.UpdateBinding:output_type -> state.v1.UpdateBindingResponse
	131, // 195: state.v1.StateStoreService.DeleteBinding:output_type -> state.v1.DeleteBindingResponse
	133, // 196: state.v1.StateStoreService.ApproveBinding:output_type -> state.v1.ApproveBindingResponse
	135, // 197: state.v1.StateStoreService.ArmedBindingsForSource:output_type -> state.v1.ArmedBindingsForSourceResponse
	137, // 198: state.v1.StateStoreService.RecordDispatch:output_type -> state.v1.RecordDispatchResponse
	139, // 199: state.v1.StateStoreService.RecordPlaybookDispatch:output_type -> state.v1.RecordPlaybookDispatchResponse
	141, // 200: state.v1.StateStoreService.DeletePlaybookDispatches:output_type -> state.v1.DeletePlaybookDispatchesResponse
	143, // 201: state.v1.StateStoreService.ListUndispatchedCaptures:output_type -> state.v1.ListUndispatchedCapturesResponse
	145, // 202: state.v1.StateStoreService.StreamUndispatchedCaptures:output_type -> state.v1.StreamUndispatchedCapturesResponse
	147, // 203: state.v1.StateStoreService.EnqueueBindingTask:output_type -> state.v1.EnqueueBindingTaskResponse
