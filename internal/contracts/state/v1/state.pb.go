...
const file_state_v1_state_proto_rawDesc = "" +
	...
	"\x04task\x18\x01 \x01(\v2\x0e.state.v1.TaskR\x04task2\x9b/\n" +
	...
	"\rDeleteMapping\x12\x1e.state.v1.DeleteMappingRequest\x1a\x1f.state.v1.DeleteMappingResponse\x12V\n" +
...
var file_state_v1_state_proto_msgTypes = make([]protoimpl.MessageInfo, 163)
var file_state_v1_state_proto_goTypes = []any{
	...
	(*InsertEventTypeRequest)(nil),             // 127: state.v1.InsertEventTypeRequest
	(*InsertEventTypeResponse)(nil),            // 128: state.v1.InsertEventTypeResponse
	(*UpdateEventTypeRequest)(nil),             // 129: state.v1.UpdateEventTypeRequest
	(*UpdateEventTypeResponse)(nil),            // 130: state.v1.UpdateEventTypeResponse
	(*DeleteEventTypeRequest)(nil),             // 131: state.v1.DeleteEventTypeRequest
	(*DeleteEventTypeResponse)(nil),            // 132: state.v1.DeleteEventTypeResponse
	(*ListEventTypesRequest)(nil),              // 133: state.v1.ListEventTypesRequest
	(*ListEventTypesResponse)(nil),             // 134: state.v1.ListEventTypesResponse
	(*InsertBindingRequest)(nil),               // 135: state.v1.InsertBindingRequest
	(*InsertBindingResponse)(nil),              // 136: state.v1.InsertBindingResponse
	(*GetBindingRequest)(nil),                  // 137: state.v1.GetBindingRequest
	(*GetBindingResponse)(nil),                 // 138: state.v1.GetBindingResponse
	(*ListBindingsRequest)(nil),                // 139: state.v1.ListBindingsRequest
	(*ListBindingsResponse)(nil),               // 140: state.v1.ListBindingsResponse
	(*UpdateBindingRequest)(nil),               // 141: state.v1.UpdateBindingRequest
	(*UpdateBindingResponse)(nil),              // 142: state.v1.UpdateBindingResponse
	(*DeleteBindingRequest)(nil),               // 143: state.v1.DeleteBindingRequest
	(*DeleteBindingResponse)(nil),              // 144: state.v1.DeleteBindingResponse
	(*ApproveBindingRequest)(nil),              // 145: state.v1.ApproveBindingRequest
	(*ApproveBindingResponse)(nil),             // 146: state.v1.ApproveBindingResponse
	...
	nil,                                        // 161: state.v1.EventType.SchemaEntry
	nil,                                        // 162: state.v1.StatusCountsResponse.CountsEntry
	(*timestamppb.Timestamp)(nil),              // 163: google.protobuf.Timestamp
}
var file_state_v1_state_proto_depIdxs = []int32{
	163, // 0: state.v1.Identity.created_at:type_name -> google.protobuf.Timestamp
	163, // 1: state.v1.Identity.updated_at:type_name -> google.protobuf.Timestamp
	...
	163, // 17: state.v1.Task.created_at:type_name -> google.protobuf.Timestamp
	163, // 18: state.v1.Task.updated_at:type_name -> google.protobuf.Timestamp
	163, // 19: state.v1.Event.at:type_name -> google.protobuf.Timestamp
	163, // 20: state.v1.CapturedEvent.received_at:type_name -> google.protobuf.Timestamp
	...
	161, // 23: state.v1.EventType.schema:type_name -> state.v1.EventType.SchemaEntry
	163, // 24: state.v1.EventType.created_at:type_name -> google.protobuf.Timestamp
	163, // 25: state.v1.EventType.updated_at:type_name -> google.protobuf.Timestamp
	30,  // 26: state.v1.Mapping.fields:type_name -> state.v1.MappingField
	163, // 27: state.v1.Mapping.created_at:type_name -> google.protobuf.Timestamp
	163, // 28: state.v1.Mapping.updated_at:type_name -> google.protobuf.Timestamp
	32,  // 29: state.v1.Binding.matcher:type_name -> state.v1.BindingMatcher
	163, // 30: state.v1.Binding.created_at:type_name -> google.protobuf.Timestamp
	163, // 31: state.v1.Binding.updated_at:type_name -> google.protobuf.Timestamp
	24,  // 32: state.v1.EnqueueChatTaskResponse.task:type_name -> state.v1.Task
	24,  // 33: state.v1.ClaimNextResponse.task:type_name -> state.v1.Task
	24,  // 34: state.v1.ClaimByIssueResponse.task:type_name -> state.v1.Task
	24,  // 35: state.v1.UpdateRequest.task:type_name -> state.v1.Task
	25,  // 36: state.v1.ArchiveTaskRequest.audit:type_name -> state.v1.Event
	24,  // 37: state.v1.TaskByIssueResponse.task:type_name -> state.v1.Task
	24,  // 38: state.v1.OpenTaskByPRResponse.task:type_name -> state.v1.Task
	24,  // 39: state.v1.TaskByIDResponse.task:type_name -> state.v1.Task
	24,  // 40: state.v1.OpenPRsResponse.tasks:type_name -> state.v1.Task
	24,  // 41: state.v1.TasksResponse.tasks:type_name -> state.v1.Task
	162, // 42: state.v1.StatusCountsResponse.counts:type_name -> state.v1.StatusCountsResponse.CountsEntry
	25,  // 43: state.v1.InsertEventRequest.event:type_name -> state.v1.Event
	25,  // 44: state.v1.EventsSinceResponse.events:type_name -> state.v1.Event
	25,  // 45: state.v1.TaskEventsResponse.events:type_name -> state.v1.Event
	34,  // 46: state.v1.WorkflowStatsResponse.stats:type_name -> state.v1.WorkflowStat
	35,  // 47: state.v1.StageStatsResponse.stats:type_name -> state.v1.StageStat
	36,  // 48: state.v1.TokensByDayResponse.tokens:type_name -> state.v1.DayTokens
	163, // 49: state.v1.ConfigSnapshot.published_at:type_name -> google.protobuf.Timestamp
	91,  // 50: state.v1.PutConfigSnapshotRequest.snapshot:type_name -> state.v1.ConfigSnapshot
	91,  // 51: state.v1.GetConfigSnapshotResponse.snapshot:type_name -> state.v1.ConfigSnapshot
	163, // 52: state.v1.ChannelStatus.observed_at:type_name -> google.protobuf.Timestamp
	96,  // 53: state.v1.PutChannelStatusRequest.channels:type_name -> state.v1.ChannelStatus
	96,  // 54: state.v1.ListChannelStatusResponse.channels:type_name -> state.v1.ChannelStatus
	163, // 55: state.v1.ApplyStatus.reported_at:type_name -> google.protobuf.Timestamp
	101, // 56: state.v1.PutApplyStatusRequest.status:type_name -> state.v1.ApplyStatus
	101, // 57: state.v1.ListApplyStatusResponse.statuses:type_name -> state.v1.ApplyStatus
	163, // 58: state.v1.TaskLogEntry.time:type_name -> google.protobuf.Timestamp
	163, // 59: state.v1.ReadTaskLogRequest.since:type_name -> google.protobuf.Timestamp
	163, // 60: state.v1.ReadTaskLogRequest.until:type_name -> google.protobuf.Timestamp
	106, // 61: state.v1.ReadTaskLogResponse.entries:type_name -> state.v1.TaskLogEntry
	26,  // 62: state.v1.InsertCaptureRequest.capture:type_name -> state.v1.CapturedEvent
	26,  // 63: state.v1.ListCapturesResponse.captures:type_name -> state.v1.CapturedEvent
	26,  // 64: state.v1.StreamCapturesResponse.capture:type_name -> state.v1.CapturedEvent
	31,  // 65: state.v1.InsertMappingRequest.mapping:type_name -> state.v1.Mapping
	31,  // 66: state.v1.GetMappingResponse.mapping:type_name -> state.v1.Mapping
	31,  // 67: state.v1.ListMappingsResponse.mappings:type_name -> state.v1.Mapping
	31,  // 68: state.v1.UpdateMappingRequest.mapping:type_name -> state.v1.Mapping
	29,  // 69: state.v1.InsertEventTypeRequest.event_type:type_name -> state.v1.EventType
	29,  // 70: state.v1.UpdateEventTypeRequest.event_type:type_name -> state.v1.EventType
	29,  // 71: state.v1.ListEventTypesResponse.event_types:type_name -> state.v1.EventType
	33,  // 72: state.v1.InsertBindingRequest.binding:type_name -> state.v1.Binding
	33,  // 73: state.v1.GetBindingResponse.binding:type_name -> state.v1.Binding
	33,  // 74: state.v1.ListBindingsResponse.bindings:type_name -> state.v1.Binding
	33,  // 75: state.v1.UpdateBindingRequest.binding:type_name -> state.v1.Binding
	33,  // 76: state.v1.ArmedBindingsForSourceResponse.bindings:type_name -> state.v1.Binding
	26,  // 77: state.v1.ListUndispatchedCapturesResponse.captures:type_name -> state.v1.CapturedEvent
	26,  // 78: state.v1.StreamUndispatchedCapturesResponse.capture:type_name -> state.v1.CapturedEvent
	24,  // 79: state.v1.EnqueueBindingTaskResponse.task:type_name -> state.v1.Task
	0,   // 80: state.v1.StateStoreService.RegisterTaskGrant:input_type -> state.v1.RegisterTaskGrantRequest
	2,   // 81: state.v1.StateStoreService.RevokeTaskGrant:input_type -> state.v1.RevokeTaskGrantRequest
	6,   // 82: state.v1.StateStoreService.ListIdentities:input_type -> state.v1.ListIdentitiesRequest
	8,   // 83: state.v1.StateStoreService.GetIdentity:input_type -> state.v1.GetIdentityRequest
	10,  // 84: state.v1.StateStoreService.CreateIdentity:input_type -> state.v1.CreateIdentityRequest
	11,  // 85: state.v1.StateStoreService.RenameIdentity:input_type -> state.v1.RenameIdentityRequest
	12,  // 86: state.v1.StateStoreService.SuspendIdentity:input_type -> state.v1.SuspendIdentityRequest
	13,  // 87: state.v1.StateStoreService.ReactivateIdentity:input_type -> state.v1.ReactivateIdentityRequest
	14,  // 88: state.v1.StateStoreService.RetireIdentity:input_type -> state.v1.RetireIdentityRequest
	20,  // 89: state.v1.StateStoreService.ResolveIdentitySubject:input_type -> state.v1.ResolveIdentitySubjectRequest
	22,  // 90: state.v1.StateStoreService.BindIdentitySubject:input_type -> state.v1.BindIdentitySubjectRequest
	37,  // 91: state.v1.StateStoreService.EnqueueIssue:input_type -> state.v1.EnqueueIssueRequest
	39,  // 92: state.v1.StateStoreService.EnqueueChatTask:input_type -> state.v1.EnqueueChatTaskRequest
	41,  // 93: state.v1.StateStoreService.ClaimNext:input_type -> state.v1.ClaimNextRequest
	43,  // 94: state.v1.StateStoreService.ClaimByIssue:input_type -> state.v1.ClaimByIssueRequest
	45,  // 95: state.v1.StateStoreService.Transition:input_type -> state.v1.TransitionRequest
	47,  // 96: state.v1.StateStoreService.Update:input_type -> state.v1.UpdateRequest
	49,  // 97: state.v1.StateStoreService.Requeue:input_type -> state.v1.RequeueRequest
	51,  // 98: state.v1.StateStoreService.ParkTask:input_type -> state.v1.ParkTaskRequest
	53,  // 99: state.v1.StateStoreService.RecoverStale:input_type -> state.v1.RecoverStaleRequest
	55,  // 100: state.v1.StateStoreService.ArchiveTask:input_type -> state.v1.ArchiveTaskRequest
	57,  // 101: state.v1.StateStoreService.RetryTask:input_type -> state.v1.RetryTaskRequest
	59,  // 102: state.v1.StateStoreService.BeginRemediation:input_type -> state.v1.BeginRemediationRequest
	61,  // 103: state.v1.StateStoreService.UpdateReviewPayload:input_type -> state.v1.UpdateReviewPayloadRequest
	63,  // 104: state.v1.StateStoreService.SetReviewCursors:input_type -> state.v1.SetReviewCursorsRequest
	65,  // 105: state.v1.StateStoreService.TaskByIssue:input_type -> state.v1.TaskByIssueRequest
	67,  // 106: state.v1.StateStoreService.OpenTaskByPR:input_type -> state.v1.OpenTaskByPRRequest
	69,  // 107: state.v1.StateStoreService.TaskByID:input_type -> state.v1.TaskByIDRequest
	71,  // 108: state.v1.StateStoreService.OpenPRs:input_type -> state.v1.OpenPRsRequest
	73,  // 109: state.v1.StateStoreService.ClearTerminalTasks:input_type -> state.v1.ClearTerminalTasksRequest
	75,  // 110: state.v1.StateStoreService.Tasks:input_type -> state.v1.TasksRequest
	77,  // 111: state.v1.StateStoreService.StatusCounts:input_type -> state.v1.StatusCountsRequest
	79,  // 112: state.v1.StateStoreService.InsertEvent:input_type -> state.v1.InsertEventRequest
	81,  // 113: state.v1.StateStoreService.EventsSince:input_type -> state.v1.EventsSinceRequest
	83,  // 114: state.v1.StateStoreService.TaskEvents:input_type -> state.v1.TaskEventsRequest
	85,  // 115: state.v1.StateStoreService.WorkflowStats:input_type -> state.v1.WorkflowStatsRequest
	87,  // 116: state.v1.StateStoreService.StageStats:input_type -> state.v1.StageStatsRequest
	89,  // 117: state.v1.StateStoreService.TokensByDay:input_type -> state.v1.TokensByDayRequest
	92,  // 118: state.v1.StateStoreService.PutConfigSnapshot:input_type -> state.v1.PutConfigSnapshotRequest
	94,  // 119: state.v1.StateStoreService.GetConfigSnapshot:input_type -> state.v1.GetConfigSnapshotRequest
	97,  // 120: state.v1.StateStoreService.PutChannelStatus:input_type -> state.v1.PutChannelStatusRequest
	99,  // 121: state.v1.StateStoreService.ListChannelStatus:input_type -> state.v1.ListChannelStatusRequest
	102, // 122: state.v1.StateStoreService.PutApplyStatus:input_type -> state.v1.PutApplyStatusRequest
	104, // 123: state.v1.StateStoreService.ListApplyStatus:input_type -> state.v1.ListApplyStatusRequest
	107, // 124: state.v1.StateStoreService.ReadTaskLog:input_type -> state.v1.ReadTaskLogRequest
	109, // 125: state.v1.StateStoreService.StreamTaskLogContent:input_type -> state.v1.StreamTaskLogContentRequest
	111, // 126: state.v1.StateStoreService.InsertCapture:input_type -> state.v1.InsertCaptureRequest
	113, // 127: state.v1.StateStoreService.ListCaptures:input_type -> state.v1.ListCapturesRequest
	115, // 128: state.v1.StateStoreService.StreamCaptures:input_type -> state.v1.StreamCapturesRequest
	117, // 129: state.v1.StateStoreService.InsertMapping:input_type -> state.v1.InsertMappingRequest
	119, // 130: state.v1.StateStoreService.GetMapping:input_type -> state.v1.GetMappingRequest
	121, // 131: state.v1.StateStoreService.ListMappings:input_type -> state.v1.ListMappingsRequest
	123, // 132: state.v1.StateStoreService.UpdateMapping:input_type -> state.v1.UpdateMappingRequest
	125, // 133: state.v1.StateStoreService.DeleteMapping:input_type -> state.v1.DeleteMappingRequest
	127, // 134: state.v1.StateStoreService.InsertEventType:input_type -> state.v1.InsertEventTypeRequest
	129, // 135: state.v1.StateStoreService.UpdateEventType:input_type -> state.v1.UpdateEventTypeRequest
	131, // 136: state.v1.StateStoreService.DeleteEventType:input_type -> state.v1.DeleteEventTypeRequest
	133, // 137: state.v1.StateStoreService.ListEventTypes:input_type -> state.v1.ListEventTypesRequest
	135, // 138: state.v1.StateStoreService.InsertBinding:input_type -> state.v1.InsertBindingRequest
	137, // 139: state.v1.StateStoreService.GetBinding:input_type -> state.v1.GetBindingRequest
	139, // 140: state.v1.StateStoreService.ListBindings:input_type -> state.v1.ListBindingsRequest
	141, // 141: state.v1.StateStoreService.UpdateBinding:input_type -> state.v1.UpdateBindingRequest
	143, // 142: state.v1.StateStoreService.DeleteBinding:input_type -> state.v1.DeleteBindingRequest
	145, // 143: state.v1.StateStoreService.ApproveBinding:input_type -> state.v1.ApproveBindingRequest
	147, // 144: state.v1.StateStoreService.ArmedBindingsForSource:input_type -> state.v1.ArmedBindingsForSourceRequest
	149, // 145: state.v1.StateStoreService.RecordDispatch:input_type -> state.v1.RecordDispatchRequest
	151, // 146: state.v1.StateStoreService.RecordPlaybookDispatch:input_type -> state.v1.RecordPlaybookDispatchRequest
	153, // 147: state.v1.StateStoreService.DeletePlaybookDispatches:input_type -> state.v1.DeletePlaybookDispatchesRequest
	155, // 148: state.v1.StateStoreService.ListUndispatchedCaptures:input_type -> state.v1.ListUndispatchedCapturesRequest
	157, // 149: state.v1.StateStoreService.StreamUndispatchedCaptures:input_type -> state.v1.StreamUndispatchedCapturesRequest
	159, // 150: state.v1.StateStoreService.EnqueueBindingTask:input_type -> state.v1.EnqueueBindingTaskRequest
	1,   // 151: state.v1.StateStoreService.RegisterTaskGrant:output_type -> state.v1.RegisterTaskGrantResponse
	3,   // 152: state.v1.StateStoreService.RevokeTaskGrant:output_type -> state.v1.RevokeTaskGrantResponse
	7,   // 153: state.v1.StateStoreService.ListIdentities:output_type -> state.v1.ListIdentitiesResponse
	9,   // 154: state.v1.StateStoreService.GetIdentity:output_type -> state.v1.GetIdentityResponse
	15,  // 155: state.v1.StateStoreService.CreateIdentity:output_type -> state.v1.CreateIdentityResponse
	16,  // 156: state.v1.StateStoreService.RenameIdentity:output_type -> state.v1.RenameIdentityResponse
	17,  // 157: state.v1.StateStoreService.SuspendIdentity:output_type -> state.v1.SuspendIdentityResponse
	18,  // 158: state.v1.StateStoreService.ReactivateIdentity:output_type -> state.v1.ReactivateIdentityResponse
	19,  // 159: state.v1.StateStoreService.RetireIdentity:output_type -> state.v1.RetireIdentityResponse
	21,  // 160: state.v1.StateStoreService.ResolveIdentitySubject:output_type -> state.v1.ResolveIdentitySubjectResponse
	23,  // 161: state.v1.StateStoreService.BindIdentitySubject:output_type -> state.v1.BindIdentitySubjectResponse
	38,  // 162: state.v1.StateStoreService.EnqueueIssue:output_type -> state.v1.EnqueueIssueResponse
	40,  // 163: state.v1.StateStoreService.EnqueueChatTask:output_type -> state.v1.EnqueueChatTaskResponse
	42,  // 164: state.v1.StateStoreService.ClaimNext:output_type -> state.v1.ClaimNextResponse
	44,  // 165: state.v1.StateStoreService.ClaimByIssue:output_type -> state.v1.ClaimByIssueResponse
	46,  // 166: state.v1.StateStoreService.Transition:output_type -> state.v1.TransitionResponse
	48,  // 167: state.v1.StateStoreService.Update:output_type -> state.v1.UpdateResponse
	50,  // 168: state.v1.StateStoreService.Requeue:output_type -> state.v1.RequeueResponse
	52,  // 169: state.v1.StateStoreService.ParkTask:output_type -> state.v1.ParkTaskResponse
	54,  // 170: state.v1.StateStoreService.RecoverStale:output_type -> state.v1.RecoverStaleResponse
	56,  // 171: state.v1.StateStoreService.ArchiveTask:output_type -> state.v1.ArchiveTaskResponse
	58,  // 172: state.v1.StateStoreService.RetryTask:output_type -> state.v1.RetryTaskResponse
	60,  // 173: state.v1.StateStoreService.BeginRemediation:output_type -> state.v1.BeginRemediationResponse
	62,  // 174: state.v1.StateStoreService.UpdateReviewPayload:output_type -> state.v1.UpdateReviewPayloadResponse
	64,  // 175: state.v1.StateStoreService.SetReviewCursors:output_type -> state.v1.SetReviewCursorsResponse
	66,  // 176: state.v1.StateStoreService.TaskByIssue:output_type -> state.v1.TaskByIssueResponse
	68,  // 177: state.v1.StateStoreService.OpenTaskByPR:output_type -> state.v1.OpenTaskByPRResponse
	70,  // 178: state.v1.StateStoreService.TaskByID:output_type -> state.v1.TaskByIDResponse
	72,  // 179: state.v1.StateStoreService.OpenPRs:output_type -> state.v1.OpenPRsResponse
	74,  // 180: state.v1.StateStoreService.ClearTerminalTasks:output_type -> state.v1.ClearTerminalTasksResponse
	76,  // 181: state.v1.StateStoreService.Tasks:output_type -> state.v1.TasksResponse
	78,  // 182: state.v1.StateStoreService.StatusCounts:output_type -> state.v1.StatusCountsResponse
	80,  // 183: state.v1.StateStoreService.InsertEvent:output_type -> state.v1.InsertEventResponse
	82,  // 184: state.v1.StateStoreService.EventsSince:output_type -> state.v1.EventsSinceResponse
	84,  // 185: state.v1.StateStoreService.TaskEvents:output_type -> state.v1.TaskEventsResponse
	86,  // 186: state.v1.StateStoreService.WorkflowStats:output_type -> state.v1.WorkflowStatsResponse
	88,  // 187: state.v1.StateStoreService.StageStats:output_type -> state.v1.StageStatsResponse
	90,  // 188: state.v1.StateStoreService.TokensByDay:output_type -> state.v1.TokensByDayResponse
	93,  // 189: state.v1.StateStoreService.PutConfigSnapshot:output_type -> state.v1.PutConfigSnapshotResponse
	95,  // 190: state.v1.StateStoreService.GetConfigSnapshot:output_type -> state.v1.GetConfigSnapshotResponse
	98,  // 191: state.v1.StateStoreService.PutChannelStatus:output_type -> state.v1.PutChannelStatusResponse
	100, // 192: state.v1.StateStoreService.ListChannelStatus:output_type -> state.v1.ListChannelStatusResponse
	103, // 193: state.v1.StateStoreService.PutApplyStatus:output_type -> state.v1.PutApplyStatusResponse
	105, // 194: state.v1.StateStoreService.ListApplyStatus:output_type -> state.v1.ListApplyStatusResponse
	108, // 195: state.v1.StateStoreService.ReadTaskLog:output_type -> state.v1.ReadTaskLogResponse
	110, // 196: state.v1.StateStoreService.StreamTaskLogContent:output_type -> state.v1.StreamTaskLogContentResponse
	112, // 197: state.v1.StateStoreService.InsertCapture:output_type -> state.v1.InsertCaptureResponse
	114, // 198: state.v1.StateStoreService.ListCaptures:output_type -> state.v1.ListCapturesResponse
	116, // 199: state.v1.StateStoreService.StreamCaptures:output_type -> state.v1.StreamCapturesResponse
	118, // 200: state.v1.StateStoreService.InsertMapping:output_type -> state.v1.InsertMappingResponse
	120, // 201: state.v1.StateStoreService.GetMapping:output_type -> state.v1.GetMappingResponse
	122, // 202: state.v1.StateStoreService.ListMappings:output_type -> state.v1.ListMappingsResponse
	124, // 203: state.v1.StateStoreService.UpdateMapping:output_type -> state.v1.UpdateMappingResponse
	126, // 204: state.v1.StateStoreService.DeleteMapping:output_type -> state.v1.DeleteMappingResponse
	128, // 205: state.v1.StateStoreService.InsertEventType:output_type -> state.v1.InsertEventTypeResponse
	130, // 206: state.v1.StateStoreService.UpdateEventType:output_type -> state.v1.UpdateEventTypeResponse
	132, // 207: state.v1.StateStoreService.DeleteEventType:output_type -> state.v1.DeleteEventTypeResponse
	134, // 208: state.v1.StateStoreService.ListEventTypes:output_type -> state.v1.ListEventTypesResponse
	136, // 209: state.v1.StateStoreService.InsertBinding:output_type -> state.v1.InsertBindingResponse
	138, // 210: state.v1.StateStoreService.GetBinding:output_type -> state.v1.GetBindingResponse
	140, // 211: state.v1.StateStoreService.ListBindings:output_type -> state.v1.ListBindingsResponse
	142, // 212: state.v1.StateStoreService.UpdateBinding:output_type -> state.v1.UpdateBindingResponse
	144, // 213: state.v1.StateStoreService.DeleteBinding:output_type -> state.v1.DeleteBindingResponse
	146, // 214: state.v1.StateStoreService.ApproveBinding:output_type -> state.v1.ApproveBindingResponse
	148, // 215: state.v1.StateStoreService.ArmedBindingsForSource:output_type -> state.v1.ArmedBindingsForSourceResponse
	150, // 216: state.v1.StateStoreService.RecordDispatch:output_type -> state.v1.RecordDispatchResponse
	152, // 217: state.v1.StateStoreService.RecordPlaybookDispatch:output_type -> state.v1.RecordPlaybookDispatchResponse
	154, // 218: state.v1.StateStoreService.DeletePlaybookDispatches:output_type -> state.v1.DeletePlaybookDispatchesResponse
	156, // 219: state.v1.StateStoreService.ListUndispatchedCaptures:output_type -> state.v1.ListUndispatchedCapturesResponse
	158, // 220: state.v1.StateStoreService.StreamUndispatchedCaptures:output_type -> state.v1.StreamUndispatchedCapturesResponse
	160, // 221: state.v1.StateStoreService.EnqueueBindingTask:output_type -> state.v1.EnqueueBindingTaskResponse
	151, // [151:222] is the sub-list for method output_type
	80,  // [80:151] is the sub-list for method input_type
