...
const file_state_v1_state_proto_rawDesc = "" +
	...
	"\x04task\x18\x01 \x01(\v2\x0e.state.v1.TaskR\x04task2\xf1\x1e\n" +
	...
	"\x0fRevokeTaskGrant\x12 .state.v1.RevokeTaskGrantRequest\x1a!.state.v1.RevokeTaskGrantResponse\x12M\n" +
...
var file_state_v1_state_proto_msgTypes = make([]protoimpl.MessageInfo, 109)
var file_state_v1_state_proto_goTypes = []any{
	...
	(*Task)(nil),                               // 4: state.v1.Task
	(*Event)(nil),                              // 5: state.v1.Event
	(*CapturedEvent)(nil),                      // 6: state.v1.CapturedEvent
	(*MappingField)(nil),                       // 7: state.v1.MappingField
	(*Mapping)(nil),                            // 8: state.v1.Mapping
	(*BindingMatcher)(nil),                     // 9: state.v1.BindingMatcher
	(*Binding)(nil),                            // 10: state.v1.Binding
	(*WorkflowStat)(nil),                       // 11: state.v1.WorkflowStat
	(*StageStat)(nil),                          // 12: state.v1.StageStat
	(*DayTokens)(nil),                          // 13: state.v1.DayTokens
	(*EnqueueIssueRequest)(nil),                // 14: state.v1.EnqueueIssueRequest
	(*EnqueueIssueResponse)(nil),               // 15: state.v1.EnqueueIssueResponse
	(*EnqueueChatTaskRequest)(nil),             // 16: state.v1.EnqueueChatTaskRequest
	(*EnqueueChatTaskResponse)(nil),            // 17: state.v1.EnqueueChatTaskResponse
	(*ClaimNextRequest)(nil),                   // 18: state.v1.ClaimNextRequest
	(*ClaimNextResponse)(nil),                  // 19: state.v1.ClaimNextResponse
	(*ClaimByIssueRequest)(nil),                // 20: state.v1.ClaimByIssueRequest
	(*ClaimByIssueResponse)(nil),               // 21: state.v1.ClaimByIssueResponse
	(*TransitionRequest)(nil),                  // 22: state.v1.TransitionRequest
	(*TransitionResponse)(nil),                 // 23: state.v1.TransitionResponse
	(*UpdateRequest)(nil),                      // 24: state.v1.UpdateRequest
	(*UpdateResponse)(nil),                     // 25: state.v1.UpdateResponse
	(*RequeueRequest)(nil),                     // 26: state.v1.RequeueRequest
	(*RequeueResponse)(nil),                    // 27: state.v1.RequeueResponse
	(*RecoverStaleRequest)(nil),                // 28: state.v1.RecoverStaleRequest
	(*RecoverStaleResponse)(nil),               // 29: state.v1.RecoverStaleResponse
	(*ArchiveTaskRequest)(nil),                 // 30: state.v1.ArchiveTaskRequest
	(*ArchiveTaskResponse)(nil),                // 31: state.v1.ArchiveTaskResponse
	(*RetryTaskRequest)(nil),                   // 32: state.v1.RetryTaskRequest
	(*RetryTaskResponse)(nil),                  // 33: state.v1.RetryTaskResponse
	(*TaskByIssueRequest)(nil),                 // 34: state.v1.TaskByIssueRequest
	(*TaskByIssueResponse)(nil),                // 35: state.v1.TaskByIssueResponse
	(*OpenTaskByPRRequest)(nil),                // 36: state.v1.OpenTaskByPRRequest
	(*OpenTaskByPRResponse)(nil),               // 37: state.v1.OpenTaskByPRResponse
	(*TaskByIDRequest)(nil),                    // 38: state.v1.TaskByIDRequest
	(*TaskByIDResponse)(nil),                   // 39: state.v1.TaskByIDResponse
	(*OpenPRsRequest)(nil),                     // 40: state.v1.OpenPRsRequest
	(*OpenPRsResponse)(nil),                    // 41: state.v1.OpenPRsResponse
	(*ClearTerminalTasksRequest)(nil),          // 42: state.v1.ClearTerminalTasksRequest
	(*ClearTerminalTasksResponse)(nil),         // 43: state.v1.ClearTerminalTasksResponse
	(*TasksRequest)(nil),                       // 44: state.v1.TasksRequest
	(*TasksResponse)(nil),                      // 45: state.v1.TasksResponse
	(*StatusCountsRequest)(nil),                // 46: state.v1.StatusCountsRequest
	(*StatusCountsResponse)(nil),               // 47: state.v1.StatusCountsResponse
	(*InsertEventRequest)(nil),                 // 48: state.v1.InsertEventRequest
	(*InsertEventResponse)(nil),                // 49: state.v1.InsertEventResponse
	(*EventsSinceRequest)(nil),                 // 50: state.v1.EventsSinceRequest
	(*EventsSinceResponse)(nil),                // 51: state.v1.EventsSinceResponse
	(*TaskEventsRequest)(nil),                  // 52: state.v1.TaskEventsRequest
	(*TaskEventsResponse)(nil),                 // 53: state.v1.TaskEventsResponse
	(*WorkflowStatsRequest)(nil),               // 54: state.v1.WorkflowStatsRequest
	(*WorkflowStatsResponse)(nil),              // 55: state.v1.WorkflowStatsResponse
	(*StageStatsRequest)(nil),                  // 56: state.v1.StageStatsRequest
	(*StageStatsResponse)(nil),                 // 57: state.v1.StageStatsResponse
	(*TokensByDayRequest)(nil),                 // 58: state.v1.TokensByDayRequest
	(*TokensByDayResponse)(nil),                // 59: state.v1.TokensByDayResponse
	(*ConfigSnapshot)(nil),                     // 60: state.v1.ConfigSnapshot
	(*PutConfigSnapshotRequest)(nil),           // 61: state.v1.PutConfigSnapshotRequest
	(*PutConfigSnapshotResponse)(nil),          // 62: state.v1.PutConfigSnapshotResponse
	(*GetConfigSnapshotRequest)(nil),           // 63: state.v1.GetConfigSnapshotRequest
	(*GetConfigSnapshotResponse)(nil),          // 64: state.v1.GetConfigSnapshotResponse
	(*TaskLogEntry)(nil),                       // 65: state.v1.TaskLogEntry
	(*ReadTaskLogRequest)(nil),                 // 66: state.v1.ReadTaskLogRequest
	(*ReadTaskLogResponse)(nil),                // 67: state.v1.ReadTaskLogResponse
	(*StreamTaskLogContentRequest)(nil),        // 68: state.v1.StreamTaskLogContentRequest
	(*StreamTaskLogContentResponse)(nil),       // 69: state.v1.StreamTaskLogContentResponse
	(*InsertCaptureRequest)(nil),               // 70: state.v1.InsertCaptureRequest
	(*InsertCaptureResponse)(nil),              // 71: state.v1.InsertCaptureResponse
	(*ListCapturesRequest)(nil),                // 72: state.v1.ListCapturesRequest
	(*ListCapturesResponse)(nil),               // 73: state.v1.ListCapturesResponse
	(*StreamCapturesRequest)(nil),              // 74: state.v1.StreamCapturesRequest
	(*StreamCapturesResponse)(nil),             // 75: state.v1.StreamCapturesResponse
	(*InsertMappingRequest)(nil),               // 76: state.v1.InsertMappingRequest
	(*InsertMappingResponse)(nil),              // 77: state.v1.InsertMappingResponse
	(*GetMappingRequest)(nil),                  // 78: state.v1.GetMappingRequest
	(*GetMappingResponse)(nil),                 // 79: state.v1.GetMappingResponse
	(*ListMappingsRequest)(nil),                // 80: state.v1.ListMappingsRequest
	(*ListMappingsResponse)(nil),               // 81: state.v1.ListMappingsResponse
	(*UpdateMappingRequest)(nil),               // 82: state.v1.UpdateMappingRequest
	(*UpdateMappingResponse)(nil),              // 83: state.v1.UpdateMappingResponse
	(*DeleteMappingRequest)(nil),               // 84: state.v1.DeleteMappingRequest
	(*DeleteMappingResponse)(nil),              // 85: state.v1.DeleteMappingResponse
	(*InsertBindingRequest)(nil),               // 86: state.v1.InsertBindingRequest
	(*InsertBindingResponse)(nil),              // 87: state.v1.InsertBindingResponse
	(*GetBindingRequest)(nil),                  // 88: state.v1.GetBindingRequest
	(*GetBindingResponse)(nil),                 // 89: state.v1.GetBindingResponse
	(*ListBindingsRequest)(nil),                // 90: state.v1.ListBindingsRequest
	(*ListBindingsResponse)(nil),               // 91: state.v1.ListBindingsResponse
	(*UpdateBindingRequest)(nil),               // 92: state.v1.UpdateBindingRequest
	(*UpdateBindingResponse)(nil),              // 93: state.v1.UpdateBindingResponse
	(*DeleteBindingRequest)(nil),               // 94: state.v1.DeleteBindingRequest
	(*DeleteBindingResponse)(nil),              // 95: state.v1.DeleteBindingResponse
	(*ApproveBindingRequest)(nil),              // 96: state.v1.ApproveBindingRequest
	(*ApproveBindingResponse)(nil),             // 97: state.v1.ApproveBindingResponse
	(*ArmedBindingsForSourceRequest)(nil),      // 98: state.v1.ArmedBindingsForSourceRequest
	(*ArmedBindingsForSourceResponse)(nil),     // 99: state.v1.ArmedBindingsForSourceResponse
	(*RecordDispatchRequest)(nil),              // 100: state.v1.RecordDispatchRequest
	(*RecordDispatchResponse)(nil),             // 101: state.v1.RecordDispatchResponse
	(*ListUndispatchedCapturesRequest)(nil),    // 102: state.v1.ListUndispatchedCapturesRequest
	(*ListUndispatchedCapturesResponse)(nil),   // 103: state.v1.ListUndispatchedCapturesResponse
	(*StreamUndispatchedCapturesRequest)(nil),  // 104: state.v1.StreamUndispatchedCapturesRequest
	(*StreamUndispatchedCapturesResponse)(nil), // 105: state.v1.StreamUndispatchedCapturesResponse
	(*EnqueueBindingTaskRequest)(nil),          // 106: state.v1.EnqueueBindingTaskRequest
	(*EnqueueBindingTaskResponse)(nil),         // 107: state.v1.EnqueueBindingTaskResponse
	nil,                                        // 108: state.v1.StatusCountsResponse.CountsEntry
	(*timestamppb.Timestamp)(nil),              // 109: google.protobuf.Timestamp
}
var file_state_v1_state_proto_depIdxs = []int32{
	109, // 0: state.v1.Task.created_at:type_name -> google.protobuf.Timestamp
	109, // 1: state.v1.Task.updated_at:type_name -> google.protobuf.Timestamp
	109, // 2: state.v1.Event.at:type_name -> google.protobuf.Timestamp
	109, // 3: state.v1.CapturedEvent.received_at:type_name -> google.protobuf.Timestamp
	7,   // 4: state.v1.Mapping.fields:type_name -> state.v1.MappingField
	109, // 5: state.v1.Mapping.created_at:type_name -> google.protobuf.Timestamp
	109, // 6: state.v1.Mapping.updated_at:type_name -> google.protobuf.Timestamp
	9,   // 7: state.v1.Binding.matcher:type_name -> state.v1.BindingMatcher
	109, // 8: state.v1.Binding.created_at:type_name -> google.protobuf.Timestamp
	109, // 9: state.v1.Binding.updated_at:type_name -> google.protobuf.Timestamp
	4,   // 10: state.v1.EnqueueChatTaskResponse.task:type_name -> state.v1.Task
	4,   // 11: state.v1.ClaimNextResponse.task:type_name -> state.v1.Task
	4,   // 12: state.v1.ClaimByIssueResponse.task:type_name -> state.v1.Task
	4,   // 13: state.v1.UpdateRequest.task:type_name -> state.v1.Task
	5,   // 14: state.v1.ArchiveTaskRequest.audit:type_name -> state.v1.Event
	4,   // 15: state.v1.TaskByIssueResponse.task:type_name -> state.v1.Task
	4,   // 16: state.v1.OpenTaskByPRResponse.task:type_name -> state.v1.Task
	4,   // 17: state.v1.TaskByIDResponse.task:type_name -> state.v1.Task
	4,   // 18: state.v1.OpenPRsResponse.tasks:type_name -> state.v1.Task
	4,   // 19: state.v1.TasksResponse.tasks:type_name -> state.v1.Task
	108, // 20: state.v1.StatusCountsResponse.counts:type_name -> state.v1.StatusCountsResponse.CountsEntry
	5,   // 21: state.v1.InsertEventRequest.event:type_name -> state.v1.Event
	5,   // 22: state.v1.EventsSinceResponse.events:type_name -> state.v1.Event
	5,   // 23: state.v1.TaskEventsResponse.events:type_name -> state.v1.Event
	11,  // 24: state.v1.WorkflowStatsResponse.stats:type_name -> state.v1.WorkflowStat
	12,  // 25: state.v1.StageStatsResponse.stats:type_name -> state.v1.StageStat
	13,  // 26: state.v1.TokensByDayResponse.tokens:type_name -> state.v1.DayTokens
	109, // 27: state.v1.ConfigSnapshot.published_at:type_name -> google.protobuf.Timestamp
	60,  // 28: state.v1.PutConfigSnapshotRequest.snapshot:type_name -> state.v1.ConfigSnapshot
	60,  // 29: state.v1.GetConfigSnapshotResponse.snapshot:type_name -> state.v1.ConfigSnapshot
	109, // 30: state.v1.TaskLogEntry.time:type_name -> google.protobuf.Timestamp
	109, // 31: state.v1.ReadTaskLogRequest.since:type_name -> google.protobuf.Timestamp
	109, // 32: state.v1.ReadTaskLogRequest.until:type_name -> google.protobuf.Timestamp
	65,  // 33: state.v1.ReadTaskLogResponse.entries:type_name -> state.v1.TaskLogEntry
	6,   // 34: state.v1.InsertCaptureRequest.capture:type_name -> state.v1.CapturedEvent
	6,   // 35: state.v1.ListCapturesResponse.captures:type_name -> state.v1.CapturedEvent
	6,   // 36: state.v1.StreamCapturesResponse.capture:type_name -> state.v1.CapturedEvent
	8,   // 37: state.v1.InsertMappingRequest.mapping:type_name -> state.v1.Mapping
	8,   // 38: state.v1.GetMappingResponse.mapping:type_name -> state.v1.Mapping
	8,   // 39: state.v1.ListMappingsResponse.mappings:type_name -> state.v1.Mapping
	8,   // 40: state.v1.UpdateMappingRequest.mapping:type_name -> state.v1.Mapping
	10,  // 41: state.v1.InsertBindingRequest.binding:type_name -> state.v1.Binding
	10,  // 42: state.v1.GetBindingResponse.binding:type_name -> state.v1.Binding
	10,  // 43: state.v1.ListBindingsResponse.bindings:type_name -> state.v1.Binding
	10,  // 44: state.v1.UpdateBindingRequest.binding:type_name -> state.v1.Binding
	10,  // 45: state.v1.ArmedBindingsForSourceResponse.bindings:type_name -> state.v1.Binding
	6,   // 46: state.v1.ListUndispatchedCapturesResponse.captures:type_name -> state.v1.CapturedEvent
	6,   // 47: state.v1.StreamUndispatchedCapturesResponse.capture:type_name -> state.v1.CapturedEvent
	4,   // 48: state.v1.EnqueueBindingTaskResponse.task:type_name -> state.v1.Task
	0,   // 49: state.v1.StateStoreService.RegisterTaskGrant:input_type -> state.v1.RegisterTaskGrantRequest
	2,   // 50: state.v1.StateStoreService.RevokeTaskGrant:input_type -> state.v1.RevokeTaskGrantRequest
	14,  // 51: state.v1.StateStoreService.EnqueueIssue:input_type -> state.v1.EnqueueIssueRequest
	16,  // 52: state.v1.StateStoreService.EnqueueChatTask:input_type -> state.v1.EnqueueChatTaskRequest
	18,  // 53: state.v1.StateStoreService.ClaimNext:input_type -> state.v1.ClaimNextRequest
	20,  // 54: state.v1.StateStoreService.ClaimByIssue:input_type -> state.v1.ClaimByIssueRequest
	22,  // 55: state.v1.StateStoreService.Transition:input_type -> state.v1.TransitionRequest
	24,  // 56: state.v1.StateStoreService.Update:input_type -> state.v1.UpdateRequest
	26,  // 57: state.v1.StateStoreService.Requeue:input_type -> state.v1.RequeueRequest
	28,  // 58: state.v1.StateStoreService.RecoverStale:input_type -> state.v1.RecoverStaleRequest
	30,  // 59: state.v1.StateStoreService.ArchiveTask:input_type -> state.v1.ArchiveTaskRequest
	32,  // 60: state.v1.StateStoreService.RetryTask:input_type -> state.v1.RetryTaskRequest
	34,  // 61: state.v1.StateStoreService.TaskByIssue:input_type -> state.v1.TaskByIssueRequest
	36,  // 62: state.v1.StateStoreService.OpenTaskByPR:input_type -> state.v1.OpenTaskByPRRequest
	38,  // 63: state.v1.StateStoreService.TaskByID:input_type -> state.v1.TaskByIDRequest
	40,  // 64: state.v1.StateStoreService.OpenPRs:input_type -> state.v1.OpenPRsRequest
	42,  // 65: state.v1.StateStoreService.ClearTerminalTasks:input_type -> state.v1.ClearTerminalTasksRequest
	44,  // 66: state.v1.StateStoreService.Tasks:input_type -> state.v1.TasksRequest
	46,  // 67: state.v1.StateStoreService.StatusCounts:input_type -> state.v1.StatusCountsRequest
	48,  // 68: state.v1.StateStoreService.InsertEvent:input_type -> state.v1.InsertEventRequest
	50,  // 69: state.v1.StateStoreService.EventsSince:input_type -> state.v1.EventsSinceRequest
	52,  // 70: state.v1.StateStoreService.TaskEvents:input_type -> state.v1.TaskEventsRequest
	54,  // 71: state.v1.StateStoreService.WorkflowStats:input_type -> state.v1.WorkflowStatsRequest
	56,  // 72: state.v1.StateStoreService.StageStats:input_type -> state.v1.StageStatsRequest
	58,  // 73: state.v1.StateStoreService.TokensByDay:input_type -> state.v1.TokensByDayRequest
	61,  // 74: state.v1.StateStoreService.PutConfigSnapshot:input_type -> state.v1.PutConfigSnapshotRequest
	63,  // 75: state.v1.StateStoreService.GetConfigSnapshot:input_type -> state.v1.GetConfigSnapshotRequest
	66,  // 76: state.v1.StateStoreService.ReadTaskLog:input_type -> state.v1.ReadTaskLogRequest
	68,  // 77: state.v1.StateStoreService.StreamTaskLogContent:input_type -> state.v1.StreamTaskLogContentRequest
	70,  // 78: state.v1.StateStoreService.InsertCapture:input_type -> state.v1.InsertCaptureRequest
	72,  // 79: state.v1.StateStoreService.ListCaptures:input_type -> state.v1.ListCapturesRequest
	74,  // 80: state.v1.StateStoreService.StreamCaptures:input_type -> state.v1.StreamCapturesRequest
	76,  // 81: state.v1.StateStoreService.InsertMapping:input_type -> state.v1.InsertMappingRequest
	78,  // 82: state.v1.StateStoreService.GetMapping:input_type -> state.v1.GetMappingRequest
	80,  // 83: state.v1.StateStoreService.ListMappings:input_type -> state.v1.ListMappingsRequest
	82,  // 84: state.v1.StateStoreService.UpdateMapping:input_type -> state.v1.UpdateMappingRequest
	84,  // 85: state.v1.StateStoreService.DeleteMapping:input_type -> state.v1.DeleteMappingRequest
	86,  // 86: state.v1.StateStoreService.InsertBinding:input_type -> state.v1.InsertBindingRequest
	88,  // 87: state.v1.StateStoreService.GetBinding:input_type -> state.v1.GetBindingRequest
	90,  // 88: state.v1.StateStoreService.ListBindings:input_type -> state.v1.ListBindingsRequest
	92,  // 89: state.v1.StateStoreService.UpdateBinding:input_type -> state.v1.UpdateBindingRequest
	94,  // 90: state.v1.StateStoreService.DeleteBinding:input_type -> state.v1.DeleteBindingRequest
	96,  // 91: state.v1.StateStoreService.ApproveBinding:input_type -> state.v1.ApproveBindingRequest
	98,  // 92: state.v1.StateStoreService.ArmedBindingsForSource:input_type -> state.v1.ArmedBindingsForSourceRequest
	100, // 93: state.v1.StateStoreService.RecordDispatch:input_type -> state.v1.RecordDispatchRequest
	102, // 94: state.v1.StateStoreService.ListUndispatchedCaptures:input_type -> state.v1.ListUndispatchedCapturesRequest
	104, // 95: state.v1.StateStoreService.StreamUndispatchedCaptures:input_type -> state.v1.StreamUndispatchedCapturesRequest
	106, // 96: state.v1.StateStoreService.EnqueueBindingTask:input_type -> state.v1.EnqueueBindingTaskRequest
	1,   // 97: state.v1.StateStoreService.RegisterTaskGrant:output_type -> state.v1.RegisterTaskGrantResponse
	3,   // 98: state.v1.StateStoreService.RevokeTaskGrant:output_type -> state.v1.RevokeTaskGrantResponse
	15,  // 99: state.v1.StateStoreService.EnqueueIssue:output_type -> state.v1.EnqueueIssueResponse
	17,  // 100: state.v1.StateStoreService.EnqueueChatTask:output_type -> state.v1.EnqueueChatTaskResponse
	19,  // 101: state.v1.StateStoreService.ClaimNext:output_type -> state.v1.ClaimNextResponse
	21,  // 102: state.v1.StateStoreService.ClaimByIssue:output_type -> state.v1.ClaimByIssueResponse
	23,  // 103: state.v1.StateStoreService.Transition:output_type -> state.v1.TransitionResponse
	25,  // 104: state.v1.StateStoreService.Update:output_type -> state.v1.UpdateResponse
	27,  // 105: state.v1.StateStoreService.Requeue:output_type -> state.v1.RequeueResponse
	29,  // 106: state.v1.StateStoreService.RecoverStale:output_type -> state.v1.RecoverStaleResponse
	31,  // 107: state.v1.StateStoreService.ArchiveTask:output_type -> state.v1.ArchiveTaskResponse
	33,  // 108: state.v1.StateStoreService.RetryTask:output_type -> state.v1.RetryTaskResponse
	35,  // 109: state.v1.StateStoreService.TaskByIssue:output_type -> state.v1.TaskByIssueResponse
	37,  // 110: state.v1.StateStoreService.OpenTaskByPR:output_type -> state.v1.OpenTaskByPRResponse
	39,  // 111: state.v1.StateStoreService.TaskByID:output_type -> state.v1.TaskByIDResponse
	41,  // 112: state.v1.StateStoreService.OpenPRs:output_type -> state.v1.OpenPRsResponse
	43,  // 113: state.v1.StateStoreService.ClearTerminalTasks:output_type -> state.v1.ClearTerminalTasksResponse
	45,  // 114: state.v1.StateStoreService.Tasks:output_type -> state.v1.TasksResponse
	47,  // 115: state.v1.StateStoreService.StatusCounts:output_type -> state.v1.StatusCountsResponse
	49,  // 116: state.v1.StateStoreService.InsertEvent:output_type -> state.v1.InsertEventResponse
	51,  // 117: state.v1.StateStoreService.EventsSince:output_type -> state.v1.EventsSinceResponse
	53,  // 118: state.v1.StateStoreService.TaskEvents:output_type -> state.v1.TaskEventsResponse
	55,  // 119: state.v1.StateStoreService.WorkflowStats:output_type -> state.v1.WorkflowStatsResponse
	57,  // 120: state.v1.StateStoreService.StageStats:output_type -> state.v1.StageStatsResponse
	59,  // 121: state.v1.StateStoreService.TokensByDay:output_type -> state.v1.TokensByDayResponse
	62,  // 122: state.v1.StateStoreService.PutConfigSnapshot:output_type -> state.v1.PutConfigSnapshotResponse
	64,  // 123: state.v1.StateStoreService.GetConfigSnapshot:output_type -> state.v1.GetConfigSnapshotResponse
	67,  // 124: state.v1.StateStoreService.ReadTaskLog:output_type -> state.v1.ReadTaskLogResponse
	69,  // 125: state.v1.StateStoreService.StreamTaskLogContent:output_type -> state.v1.StreamTaskLogContentResponse
	71,  // 126: state.v1.StateStoreService.InsertCapture:output_type -> state.v1.InsertCaptureResponse
	73,  // 127: state.v1.StateStoreService.ListCaptures:output_type -> state.v1.ListCapturesResponse
	75,  // 128: state.v1.StateStoreService.StreamCaptures:output_type -> state.v1.StreamCapturesResponse
	77,  // 129: state.v1.StateStoreService.InsertMapping:output_type -> state.v1.InsertMappingResponse
	79,  // 130: state.v1.StateStoreService.GetMapping:output_type -> state.v1.GetMappingResponse
	81,  // 131: state.v1.StateStoreService.ListMappings:output_type -> state.v1.ListMappingsResponse
	83,  // 132: state.v1.StateStoreService.UpdateMapping:output_type -> state.v1.UpdateMappingResponse
	85,  // 133: state.v1.StateStoreService.DeleteMapping:output_type -> state.v1.DeleteMappingResponse
	87,  // 134: state.v1.StateStoreService.InsertBinding:output_type -> state.v1.InsertBindingResponse
	89,  // 135: state.v1.StateStoreService.GetBinding:output_type -> state.v1.GetBindingResponse
	91,  // 136: state.v1.StateStoreService.ListBindings:output_type -> state.v1.ListBindingsResponse
	93,  // 137: state.v1.StateStoreService.UpdateBinding:output_type -> state.v1.UpdateBindingResponse
	95,  // 138: state.v1.StateStoreService.DeleteBinding:output_type -> state.v1.DeleteBindingResponse
	97,  // 139: state.v1.StateStoreService.ApproveBinding:output_type -> state.v1.ApproveBindingResponse
	99,  // 140: state.v1.StateStoreService.ArmedBindingsForSource:output_type -> state.v1.ArmedBindingsForSourceResponse
	101, // 141: state.v1.StateStoreService.RecordDispatch:output_type -> state.v1.RecordDispatchResponse
	103, // 142: state.v1.StateStoreService.ListUndispatchedCaptures:output_type -> state.v1.ListUndispatchedCapturesResponse
	105, // 143: state.v1.StateStoreService.StreamUndispatchedCaptures:output_type -> state.v1.StreamUndispatchedCapturesResponse
	107, // 144: state.v1.StateStoreService.EnqueueBindingTask:output_type -> state.v1.EnqueueBindingTaskResponse
	97,  // [97:145] is the sub-list for method output_type
	49,  // [49:97] is the sub-list for method input_type
